...
typedef enum {
    ...
    ANEURALNETWORKS_SPARSE_TO_DENSE = 78,
    ANEURALNETWORKS_SPLIT = 79,
    ANEURALNETWORKS_SQRT = 80,
    ANEURALNETWORKS_TILE = 81,
    ANEURALNETWORKS_TOPK_V2 = 82,
    ANEURALNETWORKS_TRANSPOSE_CONV_2D = 83,
    ANEURALNETWORKS_UNIDIRECTIONAL_SEQUENCE_LSTM = 84,
    ANEURALNETWORKS_UNIDIRECTIONAL_SEQUENCE_RNN = 85,
} OperationCode;
