...
Model createTestModel() {
    ...
    const std::vector<Operation> operations = {
        {
            .type = OperationType::SPARSE_TO_DENSE,
            .inputs = {0, 1, 2, 3},
            .outputs = {4},
        }
    };
...
// Create the model
Model createTestModel_relaxed_9() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3},
...
// Create the model
Model createTestModel_dynamic_output_shape_relaxed_9() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3},
...
// Create the model
Model createTestModel_relaxed_10() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3},
...
// Create the model
Model createTestModel_dynamic_output_shape_relaxed_10() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3},
...
// Create the model
Model createTestModel_relaxed_11() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3, 3},
...
// Create the model
Model createTestModel_dynamic_output_shape_relaxed_11() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3, 3},
...
// Create the model
Model createTestModel_relaxed_12() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3},
...
// Create the model
Model createTestModel_dynamic_output_shape_relaxed_12() {
    const std::vector<Operand> operands = {
        {
            .type = OperandType::TENSOR_INT32,
            .dimensions = {3},
