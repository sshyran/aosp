...
TEST_F(NeuralnetworksHidlTest, reduce_max_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal,
          is_ignored_all_inputs_as_internal,
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal());
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal,
          is_ignored_relaxed_all_inputs_as_internal,
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, reduce_max_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal,
          is_ignored_float16_all_inputs_as_internal,
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal,
          is_ignored_quant8_all_inputs_as_internal,
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_all_inputs_as_internal_2,
          is_ignored_all_inputs_as_internal_2,
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal_2());
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal_2) {
  const Model model = createTestModel_all_inputs_as_internal_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_dynamic_output_shape_2) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_relaxed_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_2,
          is_ignored_relaxed_all_inputs_as_internal_2,
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, reduce_max_float16_dynamic_output_shape_2) {
  const Model model = createTestModel_float16_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_float16_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_2,
          is_ignored_float16_all_inputs_as_internal_2,
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_dynamic_output_shape_2) {
  const Model model = createTestModel_quant8_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_quant8_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal_2,
          is_ignored_quant8_all_inputs_as_internal_2,
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_all_inputs_as_internal_3,
          is_ignored_all_inputs_as_internal_3,
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal_3());
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal_3) {
  const Model model = createTestModel_all_inputs_as_internal_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_dynamic_output_shape_3) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_relaxed_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_3,
          is_ignored_relaxed_all_inputs_as_internal_3,
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, reduce_max_float16_dynamic_output_shape_3) {
  const Model model = createTestModel_float16_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_float16_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_3,
          is_ignored_float16_all_inputs_as_internal_3,
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_dynamic_output_shape_3) {
  const Model model = createTestModel_quant8_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_quant8_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal_3,
          is_ignored_quant8_all_inputs_as_internal_3,
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_all_inputs_as_internal_4) {
  Execute(device,
          createTestModel_all_inputs_as_internal_4,
          is_ignored_all_inputs_as_internal_4,
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal_4());
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal_4) {
  const Model model = createTestModel_all_inputs_as_internal_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_all_inputs_as_internal_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, reduce_max_all_inputs_as_internal_dynamic_output_shape_4) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_all_inputs_as_internal_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_dynamic_output_shape_4) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_relaxed_all_inputs_as_internal_4) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_4,
          is_ignored_relaxed_all_inputs_as_internal_4,
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_4());
}
...
TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, reduce_max_relaxed_all_inputs_as_internal_dynamic_output_shape_4) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, reduce_max_float16_dynamic_output_shape_4) {
  const Model model = createTestModel_float16_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_float16_all_inputs_as_internal_4) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_4,
          is_ignored_float16_all_inputs_as_internal_4,
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_4());
}
...
TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, reduce_max_float16_all_inputs_as_internal_dynamic_output_shape_4) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_dynamic_output_shape_4) {
  const Model model = createTestModel_quant8_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, reduce_max_quant8_all_inputs_as_internal_4) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal_4,
          is_ignored_quant8_all_inputs_as_internal_4,
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_4());
}
...
TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, reduce_max_quant8_all_inputs_as_internal_dynamic_output_shape_4) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_max::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape_4());
  validateEverything(model, requests);
}
