...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_one_dim_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal,
          is_ignored_all_inputs_as_internal,
          ::generated_tests::select_v1_2::get_examples_one_dim_all_inputs_as_internal());
}

TEST_F(ValidationTest, select_v1_2_one_dim_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::select_v1_2::get_examples_one_dim_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_int32_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_int32_dynamic_output_shape) {
  Execute(device,
          createTestModel_int32_dynamic_output_shape,
          is_ignored_int32_dynamic_output_shape,
          ::generated_tests::select_v1_2::get_examples_one_dim_int32_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_int32_dynamic_output_shape) {
  const Model model = createTestModel_int32_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_int32_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_float16_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape,
          is_ignored_float16_dynamic_output_shape,
          ::generated_tests::select_v1_2::get_examples_one_dim_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_float16_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_one_dim_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal,
          is_ignored_float16_all_inputs_as_internal,
          ::generated_tests::select_v1_2::get_examples_one_dim_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, select_v1_2_one_dim_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_float16_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::select_v1_2::get_examples_one_dim_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_relaxed_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape,
          is_ignored_relaxed_dynamic_output_shape,
          ::generated_tests::select_v1_2::get_examples_one_dim_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_relaxed_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_one_dim_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal,
          is_ignored_relaxed_all_inputs_as_internal,
          ::generated_tests::select_v1_2::get_examples_one_dim_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, select_v1_2_one_dim_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_relaxed_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::select_v1_2::get_examples_one_dim_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_quant8_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_quant8_dynamic_output_shape,
          is_ignored_quant8_dynamic_output_shape,
          ::generated_tests::select_v1_2::get_examples_one_dim_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_quant8_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_one_dim_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal,
          is_ignored_quant8_all_inputs_as_internal,
          ::generated_tests::select_v1_2::get_examples_one_dim_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, select_v1_2_one_dim_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_one_dim_quant8_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_one_dim_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::select_v1_2::get_examples_one_dim_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_one_dim_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_one_dim_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_two_dim_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal_2,
          is_ignored_all_inputs_as_internal_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, select_v1_2_two_dim_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_2,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_int32_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_int32_dynamic_output_shape) {
  Execute(device,
          createTestModel_int32_dynamic_output_shape_2,
          is_ignored_int32_dynamic_output_shape_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_int32_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_int32_dynamic_output_shape) {
  const Model model = createTestModel_int32_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_int32_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_float16_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_2,
          is_ignored_float16_dynamic_output_shape_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_float16_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_two_dim_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_2,
          is_ignored_float16_all_inputs_as_internal_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, select_v1_2_two_dim_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_float16_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::select_v1_2::get_examples_two_dim_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_relaxed_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_2,
          is_ignored_relaxed_dynamic_output_shape_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_relaxed_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_two_dim_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_2,
          is_ignored_relaxed_all_inputs_as_internal_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, select_v1_2_two_dim_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_relaxed_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::select_v1_2::get_examples_two_dim_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_quant8_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_quant8_dynamic_output_shape_2,
          is_ignored_quant8_dynamic_output_shape_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_quant8_all_inputs_as_internal();
...
TEST_F(NeuralnetworksHidlTest, select_v1_2_two_dim_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal_2,
          is_ignored_quant8_all_inputs_as_internal_2,
          ::generated_tests::select_v1_2::get_examples_two_dim_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, select_v1_2_two_dim_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_two_dim_quant8_all_inputs_as_internal_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_two_dim_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::select_v1_2::get_examples_two_dim_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_two_dim_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_two_dim_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_five_dim_int32_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_five_dim_int32_dynamic_output_shape) {
  Execute(device,
          createTestModel_int32_dynamic_output_shape_3,
          is_ignored_int32_dynamic_output_shape_3,
          ::generated_tests::select_v1_2::get_examples_five_dim_int32_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_five_dim_int32_dynamic_output_shape) {
  const Model model = createTestModel_int32_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_five_dim_int32_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_five_dim_float16_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_five_dim_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_3,
          is_ignored_float16_dynamic_output_shape_3,
          ::generated_tests::select_v1_2::get_examples_five_dim_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_five_dim_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_five_dim_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_five_dim_relaxed_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_five_dim_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_3,
          is_ignored_relaxed_dynamic_output_shape_3,
          ::generated_tests::select_v1_2::get_examples_five_dim_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_five_dim_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_five_dim_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
std::vector<::test_helper::MixedTypedExample>& get_examples_five_dim_quant8_dynamic_output_shape();
...
TEST_F(DynamicOutputShapeTest, select_v1_2_five_dim_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_quant8_dynamic_output_shape_3,
          is_ignored_quant8_dynamic_output_shape_3,
          ::generated_tests::select_v1_2::get_examples_five_dim_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, select_v1_2_five_dim_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::select_v1_2::get_examples_five_dim_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
