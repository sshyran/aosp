...
TEST_F(NeuralnetworksHidlTest, argmax_2) {
  Execute(device,
          createTestModel,
          is_ignored,
          ::generated_tests::argmax_2::get_examples());
}

TEST_F(ValidationTest, argmax_2) {
  const Model model = createTestModel();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples());
...
TEST_F(DynamicOutputShapeTest, argmax_2_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::argmax_2::get_examples_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_dynamic_output_shape) {
  const Model model = createTestModel_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal,
          is_ignored_all_inputs_as_internal,
          ::generated_tests::argmax_2::get_examples_all_inputs_as_internal());
}

TEST_F(ValidationTest, argmax_2_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::argmax_2::get_examples_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_relaxed) {
  Execute(device,
          ...
          is_ignored_relaxed,
          ::generated_tests::argmax_2::get_examples_relaxed());
}

TEST_F(ValidationTest, argmax_2_relaxed) {
  const Model model = createTestModel_relaxed();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape,
          is_ignored_relaxed_dynamic_output_shape,
          ::generated_tests::argmax_2::get_examples_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal,
          is_ignored_relaxed_all_inputs_as_internal,
          ::generated_tests::argmax_2::get_examples_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, argmax_2_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::argmax_2::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_float16) {
  Execute(device,
          ...
          is_ignored_float16,
          ::generated_tests::argmax_2::get_examples_float16());
}

TEST_F(ValidationTest, argmax_2_float16) {
  const Model model = createTestModel_float16();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_float16());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape,
          is_ignored_float16_dynamic_output_shape,
          ::generated_tests::argmax_2::get_examples_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal,
          is_ignored_float16_all_inputs_as_internal,
          ::generated_tests::argmax_2::get_examples_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, argmax_2_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::argmax_2::get_examples_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_int32) {
  Execute(device,
          ...
          is_ignored_int32,
          ::generated_tests::argmax_2::get_examples_int32());
}

TEST_F(ValidationTest, argmax_2_int32) {
  const Model model = createTestModel_int32();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_int32());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_int32_dynamic_output_shape) {
  Execute(device,
          createTestModel_int32_dynamic_output_shape,
          is_ignored_int32_dynamic_output_shape,
          ::generated_tests::argmax_2::get_examples_int32_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_int32_dynamic_output_shape) {
  const Model model = createTestModel_int32_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_int32_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_quant8) {
  Execute(device,
          ...
          is_ignored_quant8,
          ::generated_tests::argmax_2::get_examples_quant8());
}

TEST_F(ValidationTest, argmax_2_quant8) {
  const Model model = createTestModel_quant8();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_quant8());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_quant8_dynamic_output_shape,
          is_ignored_quant8_dynamic_output_shape,
          ::generated_tests::argmax_2::get_examples_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, argmax_2_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal,
          is_ignored_quant8_all_inputs_as_internal,
          ::generated_tests::argmax_2::get_examples_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, argmax_2_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, argmax_2_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::argmax_2::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, argmax_2_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::argmax_2::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
