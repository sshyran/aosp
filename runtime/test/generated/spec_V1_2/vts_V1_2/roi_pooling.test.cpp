...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc(), true);
}

TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc) {
  const Model model = createTestModel_dynamic_output_shape_nhwc();
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_relaxed) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_relaxed(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_quant8) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_quant8(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_quant8) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_quant8());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_float16) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_float16(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_float16());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw(), true);
}

TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw) {
  const Model model = createTestModel_dynamic_output_shape_nchw();
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_relaxed) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_relaxed(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_quant8) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_quant8(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_quant8) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_quant8());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_float16) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_float16(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_float16());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_relaxed_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_relaxed_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_relaxed_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_relaxed_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_quant8_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_quant8_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_quant8_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_quant8_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_float16_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_float16_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_float16_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_float16_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_relaxed_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_relaxed_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_relaxed_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_relaxed_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_quant8_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_quant8_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_quant8_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_quant8_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_float16_2) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_float16_2(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_float16_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_float16_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_relaxed_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_relaxed_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_relaxed_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_relaxed_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_quant8_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_quant8_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_quant8_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_quant8_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nhwc_float16_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_float16_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nhwc_float16_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nhwc_float16_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_relaxed_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_relaxed_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_relaxed_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_relaxed_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_quant8_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_quant8_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_quant8_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_quant8_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, roi_pooling_dynamic_output_shape_nchw_float16_3) {
  Execute(device,
          ...
          ::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_float16_3(), true);
}
...
TEST_F(ValidationTest, roi_pooling_dynamic_output_shape_nchw_float16_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::roi_pooling::get_examples_dynamic_output_shape_nchw_float16_3());
  validateEverything(model, requests);
}
