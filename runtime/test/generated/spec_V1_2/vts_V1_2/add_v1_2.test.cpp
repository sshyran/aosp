...
TEST_F(DynamicOutputShapeTest, add_v1_2_zero_sized_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::add_v1_2::get_examples_zero_sized_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, add_v1_2_zero_sized_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::add_v1_2::get_examples_zero_sized_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, add_v1_2_zero_sized_dynamic_output_shape_quant8) {
  Execute(device,
          ...
          ::generated_tests::add_v1_2::get_examples_zero_sized_dynamic_output_shape_quant8(), true);
}
...
TEST_F(ValidationTest, add_v1_2_zero_sized_dynamic_output_shape_quant8) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::add_v1_2::get_examples_zero_sized_dynamic_output_shape_quant8());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, add_v1_2_zero_sized_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::add_v1_2::get_examples_zero_sized_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, add_v1_2_zero_sized_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::add_v1_2::get_examples_zero_sized_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
