...
Model createTestModel_nhwc_all_inputs_as_internal() {
    ...
    const std::vector<uint32_t> inputIndexes = {5, 8};
    const std::vector<uint32_t> outputIndexes = {3, 4};
    std::vector<uint8_t> operandValues = {
...
Model createTestModel_nhwc_float16_all_inputs_as_internal() {
    const std::vector<Operand> operands = {
        ...
        },
        {
            ...
            .zeroPoint = 0,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 1, .length = 2},
        },
        {
            .type = OperandType::INT32,
            .dimensions = {},
            ...
            .zeroPoint = 0,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 3, .length = 4},
        },
        {
            .type = OperandType::TENSOR_FLOAT16,
            .dimensions = {6, 4},
        ...
        },
        {
            ...
            .zeroPoint = 0,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 7, .length = 2},
        },
        {
            .type = OperandType::INT32,
            .dimensions = {},
...
Model createTestModel_nhwc_quant8_all_inputs_as_internal() {
    const std::vector<Operand> operands = {
        ...
        },
        {
            ...
            .zeroPoint = 128,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 1, .length = 1},
        },
        {
            .type = OperandType::INT32,
            .dimensions = {},
