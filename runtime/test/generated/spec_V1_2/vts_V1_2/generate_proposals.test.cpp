...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_dynamic_output_shape) {
  Execute(device,
          createTestModel_nhwc_dynamic_output_shape,
          is_ignored_nhwc_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nhwc_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nhwc_all_inputs_as_internal,
          is_ignored_nhwc_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_nhwc_relaxed_dynamic_output_shape,
          is_ignored_nhwc_relaxed_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nhwc_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nhwc_relaxed_all_inputs_as_internal,
          is_ignored_nhwc_relaxed_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_nhwc_quant8_dynamic_output_shape,
          is_ignored_nhwc_quant8_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nhwc_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_quant8_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nhwc_quant8_all_inputs_as_internal,
          is_ignored_nhwc_quant8_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_nhwc_float16_dynamic_output_shape,
          is_ignored_nhwc_float16_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nhwc_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_float16_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nhwc_float16_all_inputs_as_internal,
          is_ignored_nhwc_float16_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nhwc_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_dynamic_output_shape) {
  Execute(device,
          createTestModel_nchw_dynamic_output_shape,
          is_ignored_nchw_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nchw_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_dynamic_output_shape) {
  const Model model = createTestModel_nchw_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nchw_all_inputs_as_internal,
          is_ignored_nchw_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nchw_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_nchw_relaxed_dynamic_output_shape,
          is_ignored_nchw_relaxed_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nchw_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_nchw_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nchw_relaxed_all_inputs_as_internal,
          is_ignored_nchw_relaxed_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_nchw_quant8_dynamic_output_shape,
          is_ignored_nchw_quant8_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nchw_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_quant8_dynamic_output_shape) {
  const Model model = createTestModel_nchw_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nchw_quant8_all_inputs_as_internal,
          is_ignored_nchw_quant8_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nchw_quant8_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_nchw_float16_dynamic_output_shape,
          is_ignored_nchw_float16_dynamic_output_shape,
          ::generated_tests::generate_proposals::get_examples_nchw_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_float16_dynamic_output_shape) {
  const Model model = createTestModel_nchw_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_nchw_float16_all_inputs_as_internal,
          is_ignored_nchw_float16_all_inputs_as_internal,
          ::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_nchw_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nhwc_dynamic_output_shape_2,
          is_ignored_nhwc_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nhwc_all_inputs_as_internal_2,
          is_ignored_nhwc_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_relaxed_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nhwc_relaxed_dynamic_output_shape_2,
          is_ignored_nhwc_relaxed_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_relaxed_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_relaxed_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_relaxed_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_relaxed_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nhwc_relaxed_all_inputs_as_internal_2,
          is_ignored_nhwc_relaxed_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_relaxed_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_quant8_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nhwc_quant8_dynamic_output_shape_2,
          is_ignored_nhwc_quant8_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_quant8_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_quant8_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_quant8_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_quant8_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_quant8_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nhwc_quant8_all_inputs_as_internal_2,
          is_ignored_nhwc_quant8_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_quant8_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_quant8_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_float16_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nhwc_float16_dynamic_output_shape_2,
          is_ignored_nhwc_float16_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_float16_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_float16_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_float16_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_float16_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nhwc_float16_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nhwc_float16_all_inputs_as_internal_2,
          is_ignored_nhwc_float16_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nhwc_float16_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nhwc_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nhwc_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nhwc_float16_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nhwc_float16_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nchw_dynamic_output_shape_2,
          is_ignored_nchw_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nchw_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nchw_all_inputs_as_internal_2,
          is_ignored_nchw_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_relaxed_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nchw_relaxed_dynamic_output_shape_2,
          is_ignored_nchw_relaxed_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nchw_relaxed_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_relaxed_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_relaxed_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_relaxed_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_relaxed_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nchw_relaxed_all_inputs_as_internal_2,
          is_ignored_nchw_relaxed_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_relaxed_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_relaxed_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_quant8_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nchw_quant8_dynamic_output_shape_2,
          is_ignored_nchw_quant8_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nchw_quant8_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_quant8_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_quant8_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_quant8_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_quant8_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nchw_quant8_all_inputs_as_internal_2,
          is_ignored_nchw_quant8_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_quant8_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_quant8_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_quant8_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_quant8_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_quant8_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_float16_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_nchw_float16_dynamic_output_shape_2,
          is_ignored_nchw_float16_dynamic_output_shape_2,
          ::generated_tests::generate_proposals::get_examples_nchw_float16_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_float16_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_float16_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_float16_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, generate_proposals_nchw_float16_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_nchw_float16_all_inputs_as_internal_2,
          is_ignored_nchw_float16_all_inputs_as_internal_2,
          ::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, generate_proposals_nchw_float16_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, generate_proposals_nchw_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, generate_proposals_nchw_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_nchw_float16_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::generate_proposals::get_examples_nchw_float16_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
