...
TEST_F(DynamicOutputShapeTest, lsh_projection_float16_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::lsh_projection_float16::get_examples_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, lsh_projection_float16_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::lsh_projection_float16::get_examples_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
