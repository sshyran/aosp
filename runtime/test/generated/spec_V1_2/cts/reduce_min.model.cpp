...
void CreateModel_dynamic_output_shape_quant8(Model *model) {
  OperandType type12(Type::TENSOR_QUANT8_ASYMM, {3, 2}, 0.5f, 127);
  OperandType type16(Type::TENSOR_QUANT8_ASYMM, {0}, 0.5f, 127);
  OperandType type2(Type::TENSOR_INT32, {1});
  OperandType type3(Type::BOOL, {});
  // Phase 1, operands
  auto input0 = model->addOperand(&type12);
...
void CreateModel_quant8_2(Model *model) {
  ...
  OperandType type3(Type::BOOL, {});
  // Phase 1, operands
  auto input01 = model->addOperand(&type18);
  auto param2 = model->addOperand(&type2);
  auto param3 = model->addOperand(&type3);
...
void CreateModel_float16_3(Model *model) {
  OperandType type19(Type::TENSOR_FLOAT16, {4, 3, 2});
...
void CreateModel_quant8_3(Model *model) {
  OperandType type21(Type::TENSOR_QUANT8_ASYMM, {4, 3, 2}, 0.5f, 127);
  OperandType type22(Type::TENSOR_QUANT8_ASYMM, {2}, 0.5f, 127);
  OperandType type3(Type::BOOL, {});
  OperandType type7(Type::TENSOR_INT32, {4});
  // Phase 1, operands
  ...
  auto param4 = model->addOperand(&type7);
  auto param5 = model->addOperand(&type3);
  auto output02 = model->addOperand(&type22);
  // Phase 2, operations
  static int32_t param4_init[] = {1, 0, -3, -3};
  model->setOperandValue(param4, param4_init, sizeof(int32_t) * 4);
  static bool8 param5_init[] = {false};
...
void CreateModel_dynamic_output_shape_float16_3(Model *model) {
  ...
  auto param4 = model->addOperand(&type7);
  auto param5 = model->addOperand(&type3);
  auto output02 = model->addOperand(&type15);
  // Phase 2, operations
  static int32_t param4_init[] = {1, 0, -3, -3};
  model->setOperandValue(param4, param4_init, sizeof(int32_t) * 4);
  static bool8 param5_init[] = {false};
...
void CreateModel_float16_4(Model *model) {
  OperandType type19(Type::TENSOR_FLOAT16, {4, 3, 2});
  OperandType type23(Type::TENSOR_FLOAT16, {1, 3, 1});
  OperandType type3(Type::BOOL, {});
  OperandType type9(Type::TENSOR_INT32, {2});
  // Phase 1, operands
...
void CreateModel_quant8_4(Model *model) {
  OperandType type21(Type::TENSOR_QUANT8_ASYMM, {4, 3, 2}, 0.5f, 127);
  OperandType type24(Type::TENSOR_QUANT8_ASYMM, {1, 3, 1}, 0.5f, 127);
  OperandType type3(Type::BOOL, {});
  OperandType type9(Type::TENSOR_INT32, {2});
  // Phase 1, operands
...
void CreateModel_dynamic_output_shape_quant8_4(Model *model) {
  OperandType type21(Type::TENSOR_QUANT8_ASYMM, {4, 3, 2}, 0.5f, 127);
  OperandType type27(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0}, 0.5f, 127);
  OperandType type3(Type::BOOL, {});
  OperandType type9(Type::TENSOR_INT32, {2});
  // Phase 1, operands
  auto input03 = model->addOperand(&type21);
