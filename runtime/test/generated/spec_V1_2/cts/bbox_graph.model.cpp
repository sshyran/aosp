...
void CreateModel_zero_sized_dynamic_output_shape(Model *model) {
  ...
  auto param19 = model->addOperand(&type8);
  auto scores4 = model->addOperand(&type5);
  auto roi2 = model->addOperand(&type17);
  auto classes = model->addOperand(&type7);
  auto batches1 = model->addOperand(&type7);
  // Phase 2, operations
  static float param_init[] = {1.0f};
...
void CreateModel_zero_sized_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type18(Type::TENSOR_FLOAT16, {1, 4});
  OperandType type19(Type::TENSOR_FLOAT16, {8});
  OperandType type20(Type::TENSOR_FLOAT16, {2});
  OperandType type21(Type::TENSOR_FLOAT16, {0, 8});
  OperandType type22(Type::TENSOR_FLOAT16, {1, 1, 1, 4});
  ...
  OperandType type29(Type::TENSOR_FLOAT16, {0, 2});
  OperandType type30(Type::TENSOR_FLOAT16, {8, 4});
  OperandType type31(Type::TENSOR_FLOAT16, {2, 4});
  OperandType type7(Type::TENSOR_INT32, {0});
  OperandType type9(Type::INT32, {});
  // Phase 1, operands
  auto scores = model->addOperand(&type23);
  auto deltas = model->addOperand(&type22);
  auto anchors = model->addOperand(&type18);
  ...
  auto layout = model->addOperand(&type0);
  auto scores1 = model->addOperand(&type27);
  auto roi = model->addOperand(&type26);
  auto batches = model->addOperand(&type7);
  auto featureMap = model->addOperand(&type23);
  auto param6 = model->addOperand(&type9);
  auto param7 = model->addOperand(&type9);
  auto param8 = model->addOperand(&type25);
  auto param9 = model->addOperand(&type25);
  auto param10 = model->addOperand(&type9);
  auto param11 = model->addOperand(&type9);
  auto scores2 = model->addOperand(&type28);
  auto weights = model->addOperand(&type30);
  auto bias = model->addOperand(&type19);
  auto param12 = model->addOperand(&type9);
  auto delta = model->addOperand(&type21);
  auto weights1 = model->addOperand(&type31);
  auto bias1 = model->addOperand(&type20);
  auto param13 = model->addOperand(&type9);
  auto scores3 = model->addOperand(&type29);
  auto roi1 = model->addOperand(&type21);
  auto param14 = model->addOperand(&type25);
  auto param15 = model->addOperand(&type9);
  auto param16 = model->addOperand(&type9);
  auto param17 = model->addOperand(&type25);
  auto param18 = model->addOperand(&type25);
  auto param19 = model->addOperand(&type25);
  auto scores4 = model->addOperand(&type27);
...
void CreateModel_zero_sized_float16_dynamic_output_shape(Model *model) {
  ...
  OperandType type33(Type::TENSOR_FLOAT16, {0, 0});
  OperandType type7(Type::TENSOR_INT32, {0});
  OperandType type9(Type::INT32, {});
  // Phase 1, operands
  auto scores = model->addOperand(&type23);
  ...
  auto param5 = model->addOperand(&type25);
  auto layout = model->addOperand(&type0);
  auto scores1 = model->addOperand(&type32);
  auto roi = model->addOperand(&type26);
  auto batches = model->addOperand(&type7);
  auto featureMap = model->addOperand(&type23);
  auto param6 = model->addOperand(&type9);
  ...
  auto param18 = model->addOperand(&type25);
  auto param19 = model->addOperand(&type25);
  auto scores4 = model->addOperand(&type32);
  auto roi2 = model->addOperand(&type33);
  auto classes = model->addOperand(&type7);
  auto batches1 = model->addOperand(&type7);
  // Phase 2, operations
  static _Float16 param_init[] = {1.0f};
...
void CreateModel_zero_sized_quant8(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type34(Type::TENSOR_QUANT16_SYMM, {1, 4}, 0.125f, 0);
  OperandType type35(Type::TENSOR_INT32, {8}, 0.01f, 0);
  OperandType type36(Type::TENSOR_INT32, {2}, 0.01f, 0);
  OperandType type37(Type::TENSOR_QUANT8_ASYMM, {0, 8}, 0.1f, 128);
  OperandType type38(Type::TENSOR_QUANT8_ASYMM, {1, 1, 1, 4}, 0.1f, 128);
  OperandType type39(Type::TENSOR_QUANT8_ASYMM, {1, 1, 1, 1}, 0.1f, 128);
  OperandType type40(Type::TENSOR_QUANT16_ASYMM, {1, 2}, 0.125f, 0);
  OperandType type41(Type::TENSOR_QUANT16_ASYMM, {0, 4}, 0.125f, 0);
  OperandType type42(Type::TENSOR_QUANT16_ASYMM, {0, 8}, 0.125f, 0);
  OperandType type43(Type::TENSOR_QUANT8_ASYMM, {0}, 0.1f, 128);
  OperandType type44(Type::TENSOR_QUANT8_ASYMM, {0, 2, 2, 1}, 0.1f, 128);
  OperandType type45(Type::TENSOR_QUANT8_ASYMM, {0, 2}, 0.1f, 128);
  OperandType type46(Type::TENSOR_QUANT8_ASYMM, {8, 4}, 0.1f, 128);
  OperandType type47(Type::TENSOR_QUANT8_ASYMM, {2, 4}, 0.1f, 128);
  OperandType type7(Type::TENSOR_INT32, {0});
  OperandType type8(Type::FLOAT32, {});
  OperandType type9(Type::INT32, {});
  // Phase 1, operands
  auto scores = model->addOperand(&type39);
  auto deltas = model->addOperand(&type38);
  auto anchors = model->addOperand(&type34);
  auto imageInfo = model->addOperand(&type40);
  auto param = model->addOperand(&type8);
  auto param1 = model->addOperand(&type8);
  auto param2 = model->addOperand(&type9);
  auto param3 = model->addOperand(&type9);
  ...
  auto batches = model->addOperand(&type7);
  auto featureMap = model->addOperand(&type39);
  auto param6 = model->addOperand(&type9);
  auto param7 = model->addOperand(&type9);
  auto param8 = model->addOperand(&type8);
  auto param9 = model->addOperand(&type8);
  auto param10 = model->addOperand(&type9);
  auto param11 = model->addOperand(&type9);
  auto scores2 = model->addOperand(&type44);
  auto weights = model->addOperand(&type46);
  auto bias = model->addOperand(&type35);
  auto param12 = model->addOperand(&type9);
  auto delta = model->addOperand(&type37);
  auto weights1 = model->addOperand(&type47);
  auto bias1 = model->addOperand(&type36);
  auto param13 = model->addOperand(&type9);
  auto scores3 = model->addOperand(&type45);
  auto roi1 = model->addOperand(&type42);
  auto param14 = model->addOperand(&type8);
  auto param15 = model->addOperand(&type9);
  auto param16 = model->addOperand(&type9);
  auto param17 = model->addOperand(&type8);
  auto param18 = model->addOperand(&type8);
  auto param19 = model->addOperand(&type8);
  auto scores4 = model->addOperand(&type43);
