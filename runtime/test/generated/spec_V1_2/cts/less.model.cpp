...
void CreateModel(Model *model) {
  ...
  // Phase 2, operations
  model->addOperation(ANEURALNETWORKS_LESS, {input0, input1}, {output0});
...
void CreateModel_2(Model *model) {
  ...
  // Phase 2, operations
  model->addOperation(ANEURALNETWORKS_LESS, {input01, input11}, {output01});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input01, input11},
    {output01});
...
void CreateModel_3(Model *model) {
  ...
  // Phase 2, operations
  model->addOperation(ANEURALNETWORKS_LESS, {input02, input12}, {output02});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input02, input12},
    {output02});
...
void CreateModel_4(Model *model) {
  ...
  // Phase 2, operations
  model->addOperation(ANEURALNETWORKS_LESS, {input03, input13}, {output03});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input03, input13},
    {output03});
...
void CreateModel_5(Model *model) {
  ...
  // Phase 2, operations
  model->addOperation(ANEURALNETWORKS_LESS, {input04, input14}, {output04});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input04, input14},
    {output04});
...
void CreateModel_6(Model *model) {
  ...
  // Phase 2, operations
  model->addOperation(ANEURALNETWORKS_LESS, {input05, input15}, {output05});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input05, input15},
    {output05});
...
void CreateModel_7(Model *model) {
  ...
  // Phase 2, operations
  model->addOperation(ANEURALNETWORKS_LESS, {input06, input16}, {output06});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input06, input16},
    {output06});
