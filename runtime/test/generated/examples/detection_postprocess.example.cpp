...
static std::vector<::test_helper::MixedTypedExample> examples_regular_dynamic_output_shape_relaxed = {
// Begin of an example
{
.operands = {
//Input(s)
...
static std::vector<::test_helper::MixedTypedExample> examples_regular_dynamic_output_shape_float16 = {
// Begin of an example
{
.operands = {
//Input(s)
