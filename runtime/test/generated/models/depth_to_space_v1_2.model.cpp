...
void CreateModel_nhwc_float16_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type18(Type::TENSOR_FLOAT16, {1, 2, 2, 4});
...
void CreateModel_nhwc_quant8_2(Model *model) {
  ...
  OperandType type21(Type::TENSOR_QUANT8_ASYMM, {1, 4, 4, 1}, 0.5f, 128);
  OperandType type3(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nchw_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type22(Type::TENSOR_FLOAT32, {1, 4, 2, 2});
  OperandType type23(Type::TENSOR_FLOAT32, {1, 1, 4, 4});
  OperandType type3(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nchw_float16_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type24(Type::TENSOR_FLOAT16, {1, 4, 2, 2});
...
void CreateModel_nchw_quant8_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type26(Type::TENSOR_QUANT8_ASYMM, {1, 4, 2, 2}, 0.5f, 128);
  OperandType type27(Type::TENSOR_QUANT8_ASYMM, {1, 1, 4, 4}, 0.5f, 128);
  OperandType type3(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nhwc_float16_3(Model *model) {
  ...
  OperandType type3(Type::INT32, {});
  OperandType type30(Type::TENSOR_FLOAT16, {1, 4, 4, 2});
  // Phase 1, operands
...
void CreateModel_nhwc_quant8_3(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type3(Type::INT32, {});
  OperandType type31(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 8}, 1.0f, 0);
  OperandType type32(Type::TENSOR_QUANT8_ASYMM, {1, 4, 4, 2}, 1.0f, 0);
  // Phase 1, operands
...
void CreateModel_nchw_3(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type3(Type::INT32, {});
  OperandType type33(Type::TENSOR_FLOAT32, {1, 8, 2, 2});
  OperandType type34(Type::TENSOR_FLOAT32, {1, 2, 4, 4});
  // Phase 1, operands
...
void CreateModel_nchw_float16_3(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type3(Type::INT32, {});
  OperandType type35(Type::TENSOR_FLOAT16, {1, 8, 2, 2});
  OperandType type36(Type::TENSOR_FLOAT16, {1, 2, 4, 4});
  // Phase 1, operands
...
void CreateModel_nchw_quant8_3(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type3(Type::INT32, {});
  OperandType type37(Type::TENSOR_QUANT8_ASYMM, {1, 8, 2, 2}, 1.0f, 0);
  OperandType type38(Type::TENSOR_QUANT8_ASYMM, {1, 2, 4, 4}, 1.0f, 0);
  // Phase 1, operands
