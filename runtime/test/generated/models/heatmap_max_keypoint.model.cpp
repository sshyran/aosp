...
void CreateModel_nhwc_float16_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type14(Type::TENSOR_FLOAT16, {2, 4});
  OperandType type15(Type::TENSOR_FLOAT16, {2, 4, 4, 4});
  OperandType type16(Type::TENSOR_FLOAT16, {2, 3, 4});
  // Phase 1, operands
  auto heatmap1 = model->addOperand(&type15);
  auto boxes1 = model->addOperand(&type14);
  auto layout = model->addOperand(&type0);
