...
#if 0
TEST_F(DynamicOutputShapeTests, strided_slice_quant8_2_dynamic_output_shape) {
    execute(strided_slice_quant8_2::CreateModel_dynamic_output_shape,
            strided_slice_quant8_2::is_ignored_dynamic_output_shape,
            strided_slice_quant8_2::get_examples_dynamic_output_shape());
}
