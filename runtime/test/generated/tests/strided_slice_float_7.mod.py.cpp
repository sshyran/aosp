...
#if 0
TEST_F(DynamicOutputShapeTests, strided_slice_float_7_dynamic_output_shape) {
    execute(strided_slice_float_7::CreateModel_dynamic_output_shape,
            strided_slice_float_7::is_ignored_dynamic_output_shape,
            strided_slice_float_7::get_examples_dynamic_output_shape());
}
