...
#if 0
TEST_F(DynamicOutputShapeTests, lstm2_state_float16_dynamic_output_shape) {
    execute(lstm2_state_float16::CreateModel_dynamic_output_shape,
            lstm2_state_float16::is_ignored_dynamic_output_shape,
            lstm2_state_float16::get_examples_dynamic_output_shape());
}
