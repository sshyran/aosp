...
#if 0
TEST_F(DynamicOutputShapeTests, avg_pool_quant8_5_dynamic_output_shape) {
    execute(avg_pool_quant8_5::CreateModel_dynamic_output_shape,
            avg_pool_quant8_5::is_ignored_dynamic_output_shape,
            avg_pool_quant8_5::get_examples_dynamic_output_shape());
}
