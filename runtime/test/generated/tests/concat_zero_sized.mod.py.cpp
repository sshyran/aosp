...
TEST_AVAILABLE_SINCE(V1_2, concat_zero_sized, generated_tests::concat_zero_sized::CreateModel)
...
TEST_AVAILABLE_SINCE(V1_2, concat_zero_sized_quant8, generated_tests::concat_zero_sized::CreateModel_quant8)
...
TEST_AVAILABLE_SINCE(V1_2, concat_zero_sized_float16, generated_tests::concat_zero_sized::CreateModel_float16)
...
TEST_AVAILABLE_SINCE(V1_2, concat_zero_sized_2, generated_tests::concat_zero_sized::CreateModel_2)
...
TEST_AVAILABLE_SINCE(V1_2, concat_zero_sized_quant8_2, generated_tests::concat_zero_sized::CreateModel_quant8_2)
...
TEST_AVAILABLE_SINCE(V1_2, concat_zero_sized_float16_2, generated_tests::concat_zero_sized::CreateModel_float16_2)
