...
#if 0
TEST_F(DynamicOutputShapeTests, conv_quant8_channels_weights_as_inputs_dynamic_output_shape) {
    execute(conv_quant8_channels_weights_as_inputs::CreateModel_dynamic_output_shape,
            conv_quant8_channels_weights_as_inputs::is_ignored_dynamic_output_shape,
            conv_quant8_channels_weights_as_inputs::get_examples_dynamic_output_shape());
}
