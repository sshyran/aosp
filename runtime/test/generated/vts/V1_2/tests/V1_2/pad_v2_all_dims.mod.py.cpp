...
TEST_F(DynamicOutputShapeTest, pad_v2_all_dims_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::pad_v2_all_dims::get_examples_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, pad_v2_all_dims_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::pad_v2_all_dims::get_examples_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, pad_v2_all_dims_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::pad_v2_all_dims::get_examples_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, pad_v2_all_dims_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::pad_v2_all_dims::get_examples_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
