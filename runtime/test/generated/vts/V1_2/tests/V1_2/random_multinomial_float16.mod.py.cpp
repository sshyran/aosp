...
TEST_F(NeuralnetworksHidlTest, random_multinomial_float16) {
  Execute(device,
          createTestModel,
          is_ignored,
          ::generated_tests::random_multinomial_float16::get_examples());
}

TEST_F(ValidationTest, random_multinomial_float16) {
  const Model model = createTestModel();
  const std::vector<Request> requests = createRequests(::generated_tests::random_multinomial_float16::get_examples());
...
TEST_F(DynamicOutputShapeTest, random_multinomial_float16_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::random_multinomial_float16::get_examples_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, random_multinomial_float16_dynamic_output_shape) {
  const Model model = createTestModel_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::random_multinomial_float16::get_examples_dynamic_output_shape());
  validateEverything(model, requests);
}
