...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_quant8) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_quant8) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_relaxed_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed_2(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_relaxed_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_float16_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16_2(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_float16_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_quant8_2) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8_2(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_quant8_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_relaxed_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed_3(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_relaxed_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_float16_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16_3(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_float16_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_quant8_3) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8_3(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_quant8_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_relaxed_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed_4(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_relaxed_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_relaxed_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_float16_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16_4(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_float16_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_float16_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, reduce_min_dynamic_output_shape_quant8_4) {
  Execute(device,
          ...
          ::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8_4(), true);
}
...
TEST_F(ValidationTest, reduce_min_dynamic_output_shape_quant8_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::reduce_min::get_examples_dynamic_output_shape_quant8_4());
  validateEverything(model, requests);
}
