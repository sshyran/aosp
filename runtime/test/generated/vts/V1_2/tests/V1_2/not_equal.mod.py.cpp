...
TEST_F(DynamicOutputShapeTest, not_equal_simple_dynamic_output_shape_int32) {
  Execute(device,
          ...
          ::generated_tests::not_equal::get_examples_simple_dynamic_output_shape_int32(), true);
}
...
TEST_F(ValidationTest, not_equal_simple_dynamic_output_shape_int32) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::not_equal::get_examples_simple_dynamic_output_shape_int32());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, not_equal_simple_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::not_equal::get_examples_simple_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, not_equal_simple_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::not_equal::get_examples_simple_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, not_equal_simple_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::not_equal::get_examples_simple_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, not_equal_simple_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::not_equal::get_examples_simple_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, not_equal_broadcast_dynamic_output_shape_int32) {
  Execute(device,
          ...
          ::generated_tests::not_equal::get_examples_broadcast_dynamic_output_shape_int32(), true);
}
...
TEST_F(ValidationTest, not_equal_broadcast_dynamic_output_shape_int32) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::not_equal::get_examples_broadcast_dynamic_output_shape_int32());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, not_equal_broadcast_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::not_equal::get_examples_broadcast_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, not_equal_broadcast_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::not_equal::get_examples_broadcast_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, not_equal_broadcast_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::not_equal::get_examples_broadcast_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, not_equal_broadcast_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::not_equal::get_examples_broadcast_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
