...
Model createTestModel() {
    ...
    std::vector<uint8_t> operandValues = {
      129, 131, 133, 135, 109, 147, 105, 151, 137, 139, 141, 143, 153, 99, 157, 95, 4, 0, 0, 0, 8, 0, 0, 0, 12, 0, 0, 0, 16, 0, 0, 0, 2, 0, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0
    };
...
Model createTestModel_all_inputs_as_internal() {
    ...
    const std::vector<uint32_t> outputIndexes = {7};
    std::vector<uint8_t> operandValues = {
      129, 131, 133, 135, 109, 147, 105, 151, 137, 139, 141, 143, 153, 99, 157, 95, 4, 0, 0, 0, 8, 0, 0, 0, 12, 0, 0, 0, 16, 0, 0, 0, 2, 0, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 127, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_all_tensors_as_inputs_all_inputs_as_internal() {
    const std::vector<Operand> operands = {
        ...
        },
        {
            ...
            .zeroPoint = 127,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 21, .length = 1},
        },
        {
            .type = OperandType::INT32,
            .dimensions = {},
    ...
    const std::vector<uint32_t> inputIndexes = {2, 8, 11};
    const std::vector<uint32_t> outputIndexes = {7};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 127, 0, 0, 0, 0, 127, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
