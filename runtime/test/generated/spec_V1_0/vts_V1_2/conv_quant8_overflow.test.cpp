...
TEST_F(DynamicOutputShapeTest, conv_quant8_overflow) {
    Execute(device, ::generated_tests::conv_quant8_overflow::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, conv_quant8_overflow_all_inputs_as_internal) {
    Execute(device, ::generated_tests::conv_quant8_overflow::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, conv_quant8_overflow_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::conv_quant8_overflow::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, conv_quant8_overflow_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::conv_quant8_overflow::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
