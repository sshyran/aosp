...
TEST_F(DynamicOutputShapeTest, local_response_norm_float_4) {
    Execute(device, ::generated_tests::local_response_norm_float_4::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, local_response_norm_float_4_all_inputs_as_internal) {
    Execute(device, ::generated_tests::local_response_norm_float_4::get_test_model_all_inputs_as_internal(), true);
}
