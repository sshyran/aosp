...
TEST_F(DynamicOutputShapeTest, rnn_state) {
    Execute(device, ::generated_tests::rnn_state::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, rnn_state_all_inputs_as_internal) {
    Execute(device, ::generated_tests::rnn_state::get_test_model_all_inputs_as_internal(), true);
}
