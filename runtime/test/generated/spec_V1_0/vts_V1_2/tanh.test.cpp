...
TEST_F(DynamicOutputShapeTest, tanh) {
    Execute(device, ::generated_tests::tanh::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, tanh_all_inputs_as_internal) {
    Execute(device, ::generated_tests::tanh::get_test_model_all_inputs_as_internal(), true);
}
