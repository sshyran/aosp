...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_dynamic_output_shape) {
  const Model model = createTestModel_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_tensors_as_inputs_dynamic_output_shape,
          is_ignored_all_tensors_as_inputs_dynamic_output_shape,
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_dynamic_output_shape) {
  const Model model = createTestModel_all_tensors_as_inputs_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_dynamic_output_shape_2) {
  const Model model = createTestModel_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_2,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_2,
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_all_tensors_as_inputs_dynamic_output_shape_2,
          is_ignored_all_tensors_as_inputs_dynamic_output_shape_2,
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_dynamic_output_shape_2) {
  const Model model = createTestModel_all_tensors_as_inputs_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, conv_1_h3_w2_VALID_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::conv_1_h3_w2_VALID::get_examples_all_tensors_as_inputs_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
