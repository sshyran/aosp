...
TEST_F(DynamicOutputShapeTest, fully_connected_float_3) {
    Execute(device, ::generated_tests::fully_connected_float_3::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, fully_connected_float_3_all_inputs_as_internal) {
    Execute(device, ::generated_tests::fully_connected_float_3::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, fully_connected_float_3_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::fully_connected_float_3::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, fully_connected_float_3_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::fully_connected_float_3::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
