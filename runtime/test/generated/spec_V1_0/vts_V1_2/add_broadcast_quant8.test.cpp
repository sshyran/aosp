...
TEST_F(DynamicOutputShapeTest, add_broadcast_quant8) {
    Execute(device, ::generated_tests::add_broadcast_quant8::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, add_broadcast_quant8_all_inputs_as_internal) {
    Execute(device, ::generated_tests::add_broadcast_quant8::get_test_model_all_inputs_as_internal(), true);
}
