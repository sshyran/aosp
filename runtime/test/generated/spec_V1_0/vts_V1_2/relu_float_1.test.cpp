...
TEST_F(DynamicOutputShapeTest, relu_float_1) {
    Execute(device, ::generated_tests::relu_float_1::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, relu_float_1_all_inputs_as_internal) {
    Execute(device, ::generated_tests::relu_float_1::get_test_model_all_inputs_as_internal(), true);
}
