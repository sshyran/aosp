...
TEST_F(DynamicOutputShapeTest, embedding_lookup) {
    Execute(device, ::generated_tests::embedding_lookup::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, embedding_lookup_all_inputs_as_internal) {
    Execute(device, ::generated_tests::embedding_lookup::get_test_model_all_inputs_as_internal(), true);
}
