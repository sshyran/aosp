...
TEST_F(DynamicOutputShapeTest, max_pool_quant8_1) {
    Execute(device, ::generated_tests::max_pool_quant8_1::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, max_pool_quant8_1_all_inputs_as_internal) {
    Execute(device, ::generated_tests::max_pool_quant8_1::get_test_model_all_inputs_as_internal(), true);
}
