...
TEST_F(DynamicOutputShapeTest, lstm) {
    Execute(device, ::generated_tests::lstm::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, lstm_all_inputs_as_internal) {
    Execute(device, ::generated_tests::lstm::get_test_model_all_inputs_as_internal(), true);
}
