...
TEST_F(DynamicOutputShapeTest, lstm2_state2) {
    Execute(device, ::generated_tests::lstm2_state2::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, lstm2_state2_all_inputs_as_internal) {
    Execute(device, ::generated_tests::lstm2_state2::get_test_model_all_inputs_as_internal(), true);
}
