...
TEST_F(DynamicOutputShapeTest, space_to_depth_float_1) {
    Execute(device, ::generated_tests::space_to_depth_float_1::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, space_to_depth_float_1_all_inputs_as_internal) {
    Execute(device, ::generated_tests::space_to_depth_float_1::get_test_model_all_inputs_as_internal(), true);
}
