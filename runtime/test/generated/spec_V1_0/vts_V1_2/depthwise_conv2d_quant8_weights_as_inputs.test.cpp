...
TEST_F(DynamicOutputShapeTest, depthwise_conv2d_quant8_weights_as_inputs) {
    Execute(device, ::generated_tests::depthwise_conv2d_quant8_weights_as_inputs::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv2d_quant8_weights_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::depthwise_conv2d_quant8_weights_as_inputs::get_test_model_all_inputs_as_internal(), true);
}
