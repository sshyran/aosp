...
TEST_F(DynamicOutputShapeTest, space_to_depth_float_2) {
    Execute(device, ::generated_tests::space_to_depth_float_2::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, space_to_depth_float_2_all_inputs_as_internal) {
    Execute(device, ::generated_tests::space_to_depth_float_2::get_test_model_all_inputs_as_internal(), true);
}
