...
TEST_F(DynamicOutputShapeTest, concat_quant8_3) {
    Execute(device, ::generated_tests::concat_quant8_3::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, concat_quant8_3_all_inputs_as_internal) {
    Execute(device, ::generated_tests::concat_quant8_3::get_test_model_all_inputs_as_internal(), true);
}
