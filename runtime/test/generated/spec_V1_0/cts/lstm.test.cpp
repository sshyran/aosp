...
TEST_F(GeneratedTests, lstm_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, lstm_all_inputs_as_internal, generated_tests::lstm::CreateModel_all_inputs_as_internal)
