    ...
    static TestModel model = {
        ...
        .main = {
                ...
                .operands = {{
                            ...
                            .channelQuant = {},
                            .data = TestBuffer::createFromVector<float>({-0.275f, 0.15f, 0.175f, 0.3f, -0.175f, 0.025f}),
                            .dimensions = {1, 1, 1, 6},
                            .isIgnored = false,
...
const auto dummy_test_model = TestModelManager::get().add("local_response_norm_float_3_relaxed", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("local_response_norm_float_3_relaxed_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
