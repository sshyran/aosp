...
const auto dummy_test_model_all_tensors_as_inputs = TestModelManager::get().add("strided_slice_float_9_all_tensors_as_inputs", get_test_model_all_tensors_as_inputs());
...
const auto dummy_test_model_all_tensors_as_inputs_all_inputs_as_internal = TestModelManager::get().add("strided_slice_float_9_all_tensors_as_inputs_all_inputs_as_internal", get_test_model_all_tensors_as_inputs_all_inputs_as_internal());
