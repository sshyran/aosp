...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  ...
  .quant8AsymmOperands = {{0, {1, 2, 3, 4, 5, 6, 7, 8}}},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  ...
  .int32Operands = {},
  // int -> QUANT8_ASYMM map
  .quant8AsymmOperands = {{0, {0, 0, 0, 0, 0, 5, 0, 0, 0, 0, 0, 0, 0, 6, 0, 0, 0, 1, 0, 0, 0, 7, 0, 0, 0, 2, 0, 0, 0, 8, 0, 0, 0, 3, 0, 0, 0, 0, 0, 0, 0, 4, 0, 0, 0, 0, 0, 0}}},
  // int -> QUANT16_SYMM map
  .quant16SymmOperands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  // int -> Dimensions map
  .operandDimensions = {{0, {1, 4, 2, 1}}, {1, {2}}, {2, {2, 2}}},
  // int -> FLOAT32 map
  .float32Operands = {},
  // int -> INT32 map
  .int32Operands = {{1, {3, 2}}, {2, {1, 1, 2, 4}}},
  // int -> QUANT8_ASYMM map
  .quant8AsymmOperands = {{0, {1, 2, 3, 4, 5, 6, 7, 8}}},
  // int -> QUANT16_SYMM map
  .quant16SymmOperands = {},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  // int -> Dimensions map
  .operandDimensions = {{0, {2}}, {1, {2, 2}}, {2, {1, 4, 2, 1}}},
  // int -> FLOAT32 map
  .float32Operands = {},
  // int -> INT32 map
  .int32Operands = {{0, {3, 2}}, {1, {1, 1, 2, 4}}},
  // int -> QUANT8_ASYMM map
  .quant8AsymmOperands = {{2, {1, 2, 3, 4, 5, 6, 7, 8}}},
  // int -> QUANT16_SYMM map
  .quant16SymmOperands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
