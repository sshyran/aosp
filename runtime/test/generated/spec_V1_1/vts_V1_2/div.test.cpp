...
TEST_F(DynamicOutputShapeTest, div) {
    Execute(device, ::generated_tests::div::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, div_all_inputs_as_internal) {
    Execute(device, ::generated_tests::div::get_test_model_all_inputs_as_internal(), true);
}
