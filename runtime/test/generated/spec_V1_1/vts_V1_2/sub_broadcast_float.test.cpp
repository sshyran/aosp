...
TEST_F(DynamicOutputShapeTest, sub_broadcast_float_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::sub_broadcast_float::get_examples_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, sub_broadcast_float_dynamic_output_shape) {
  const Model model = createTestModel_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::sub_broadcast_float::get_examples_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, sub_broadcast_float_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::sub_broadcast_float::get_examples_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, sub_broadcast_float_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::sub_broadcast_float::get_examples_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
