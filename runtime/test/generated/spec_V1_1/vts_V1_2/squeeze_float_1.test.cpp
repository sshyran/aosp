...
TEST_F(DynamicOutputShapeTest, squeeze_float_1) {
    Execute(device, ::generated_tests::squeeze_float_1::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, squeeze_float_1_all_inputs_as_internal) {
    Execute(device, ::generated_tests::squeeze_float_1::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, squeeze_float_1_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::squeeze_float_1::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, squeeze_float_1_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::squeeze_float_1::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
