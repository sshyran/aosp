...
TEST_F(DynamicOutputShapeTest, logistic_float_1_relaxed) {
    Execute(device, ::generated_tests::logistic_float_1_relaxed::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, logistic_float_1_relaxed_all_inputs_as_internal) {
    Execute(device, ::generated_tests::logistic_float_1_relaxed::get_test_model_all_inputs_as_internal(), true);
}
