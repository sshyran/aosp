...
TEST_F(DynamicOutputShapeTest, max_pool_float_4_relaxed) {
    Execute(device, ::generated_tests::max_pool_float_4_relaxed::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, max_pool_float_4_relaxed_all_inputs_as_internal) {
    Execute(device, ::generated_tests::max_pool_float_4_relaxed::get_test_model_all_inputs_as_internal(), true);
}
