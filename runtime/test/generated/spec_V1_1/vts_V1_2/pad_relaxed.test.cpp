...
TEST_F(DynamicOutputShapeTest, pad_relaxed) {
    Execute(device, ::generated_tests::pad_relaxed::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, pad_relaxed_all_inputs_as_internal) {
    Execute(device, ::generated_tests::pad_relaxed::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, pad_relaxed_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::pad_relaxed::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, pad_relaxed_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::pad_relaxed::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
