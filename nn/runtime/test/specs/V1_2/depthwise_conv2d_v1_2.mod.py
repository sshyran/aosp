...
example = Example({
    ...
    o1: [11, 3, 7.2, 10.6,
         ...
         11, 3, 7.8, 11.5,
         11, 3, 8.0, 11.8]
}).AddNchw([i1, o1], [layout], defaultName="nhwc")
...
}).AddNchw([i2, o2], [layout], defaultName="nhwc")
example.AddInput([f2, b2]).AddVariations("relaxed", quant8)
...
example = Example({
    ...
    o3: [110, 246]
}).AddNchw([i3, o3], [layout], defaultName="nhwc")
example.AddInput([f3, b3]).AddVariations("relaxed", quant8)
...
}).AddNchw([i4, o4], [layout], defaultName="nhwc")
example.AddInput([f4, b4]).AddVariations("relaxed", quant8)
