...
TEST_F(DynamicOutputShapeTest, div_v1_2_zero_sized_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::div_v1_2::get_examples_zero_sized_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, div_v1_2_zero_sized_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::div_v1_2::get_examples_zero_sized_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, div_v1_2_zero_sized_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::div_v1_2::get_examples_zero_sized_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, div_v1_2_zero_sized_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::div_v1_2::get_examples_zero_sized_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
