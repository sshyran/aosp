...
TEST_F(DynamicOutputShapeTest, split_float_4_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::split_float_4::get_examples_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, split_float_4_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::split_float_4::get_examples_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, split_float_4_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::split_float_4::get_examples_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, split_float_4_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::split_float_4::get_examples_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
