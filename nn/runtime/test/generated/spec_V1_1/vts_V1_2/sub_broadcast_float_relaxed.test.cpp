...
TEST_F(DynamicOutputShapeTest, sub_broadcast_float_relaxed) {
    Execute(device, ::generated_tests::sub_broadcast_float_relaxed::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, sub_broadcast_float_relaxed_all_inputs_as_internal) {
    Execute(device, ::generated_tests::sub_broadcast_float_relaxed::get_test_model_all_inputs_as_internal(), true);
}
