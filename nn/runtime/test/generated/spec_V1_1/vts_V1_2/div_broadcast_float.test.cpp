...
TEST_F(DynamicOutputShapeTest, div_broadcast_float) {
    Execute(device, ::generated_tests::div_broadcast_float::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, div_broadcast_float_all_inputs_as_internal) {
    Execute(device, ::generated_tests::div_broadcast_float::get_test_model_all_inputs_as_internal(), true);
}
