...
TEST_F(DynamicOutputShapeTest, strided_slice_qaunt8_11) {
    Execute(device, ::generated_tests::strided_slice_qaunt8_11::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, strided_slice_qaunt8_11_all_inputs_as_internal) {
    Execute(device, ::generated_tests::strided_slice_qaunt8_11::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, strided_slice_qaunt8_11_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::strided_slice_qaunt8_11::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, strided_slice_qaunt8_11_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::strided_slice_qaunt8_11::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
