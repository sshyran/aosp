...
TEST_F(DynamicOutputShapeTest, tanh_relaxed) {
    Execute(device, ::generated_tests::tanh_relaxed::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, tanh_relaxed_all_inputs_as_internal) {
    Execute(device, ::generated_tests::tanh_relaxed::get_test_model_all_inputs_as_internal(), true);
}
