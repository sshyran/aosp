...
TEST_F(DynamicOutputShapeTest, depth_to_space_float_3_relaxed) {
    Execute(device, ::generated_tests::depth_to_space_float_3_relaxed::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, depth_to_space_float_3_relaxed_all_inputs_as_internal) {
    Execute(device, ::generated_tests::depth_to_space_float_3_relaxed::get_test_model_all_inputs_as_internal(), true);
}
