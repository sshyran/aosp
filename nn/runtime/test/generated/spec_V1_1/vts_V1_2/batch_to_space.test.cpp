...
TEST_F(DynamicOutputShapeTest, batch_to_space) {
    Execute(device, ::generated_tests::batch_to_space::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, batch_to_space_all_inputs_as_internal) {
    Execute(device, ::generated_tests::batch_to_space::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, batch_to_space_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::batch_to_space::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, batch_to_space_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::batch_to_space::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
