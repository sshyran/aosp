...
TEST_F(DynamicOutputShapeTest, fully_connected_float_weights_as_inputs_relaxed) {
    Execute(device, ::generated_tests::fully_connected_float_weights_as_inputs_relaxed::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, fully_connected_float_weights_as_inputs_relaxed_all_inputs_as_internal) {
    Execute(device, ::generated_tests::fully_connected_float_weights_as_inputs_relaxed::get_test_model_all_inputs_as_internal(), true);
}
