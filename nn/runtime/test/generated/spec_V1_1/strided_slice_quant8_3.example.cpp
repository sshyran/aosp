...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  // int -> Dimensions map
  .operandDimensions = {{0, {4}}, {1, {1}}, {2, {1}}, {3, {1}}},
  // int -> FLOAT32 map
  .float32Operands = {},
  // int -> INT32 map
  .int32Operands = {{1, {-5}}, {2, {3}}, {3, {1}}},
  // int -> QUANT8_ASYMM map
  .quant8AsymmOperands = {{0, {1, 2, 3, 4}}},
  // int -> QUANT16_SYMM map
  .quant16SymmOperands = {},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  // int -> Dimensions map
  .operandDimensions = {{0, {1}}, {1, {1}}, {2, {1}}, {3, {4}}},
  // int -> FLOAT32 map
  .float32Operands = {},
  // int -> INT32 map
  .int32Operands = {{0, {-5}}, {1, {3}}, {2, {1}}},
  // int -> QUANT8_ASYMM map
  .quant8AsymmOperands = {{3, {1, 2, 3, 4}}},
  // int -> QUANT16_SYMM map
  .quant16SymmOperands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
