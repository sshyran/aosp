...
TEST_F(GeneratedTests, strided_slice_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_1, strided_slice_all_inputs_as_internal, generated_tests::strided_slice::CreateModel_all_inputs_as_internal)
...
TEST_F(GeneratedTests, strided_slice_all_tensors_as_inputs) {
...
TEST_AVAILABLE_SINCE(V1_1, strided_slice_all_tensors_as_inputs, generated_tests::strided_slice::CreateModel_all_tensors_as_inputs)
...
TEST_F(GeneratedTests, strided_slice_all_tensors_as_inputs_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_1, strided_slice_all_tensors_as_inputs_all_inputs_as_internal, generated_tests::strided_slice::CreateModel_all_tensors_as_inputs_all_inputs_as_internal)
