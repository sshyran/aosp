...
TEST_F(GeneratedTests, mean_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_1, mean_all_inputs_as_internal, generated_tests::mean::CreateModel_all_inputs_as_internal)
...
TEST_F(GeneratedTests, mean_all_tensors_as_inputs) {
...
TEST_AVAILABLE_SINCE(V1_1, mean_all_tensors_as_inputs, generated_tests::mean::CreateModel_all_tensors_as_inputs)
...
TEST_F(GeneratedTests, mean_all_tensors_as_inputs_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_1, mean_all_tensors_as_inputs_all_inputs_as_internal, generated_tests::mean::CreateModel_all_tensors_as_inputs_all_inputs_as_internal)
