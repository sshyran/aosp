...
void CreateModel_quant8_2(Model *model) {
  OperandType type0(Type::TENSOR_FLOAT32, {300});
  OperandType type3(Type::TENSOR_QUANT8_ASYMM, {300}, 1.0f, 1);
  // Phase 1, operands
...
void CreateModel_quant8_3(Model *model) {
  OperandType type0(Type::TENSOR_FLOAT32, {300});
  OperandType type4(Type::TENSOR_QUANT8_ASYMM, {300}, 0.01f, 120);
  // Phase 1, operands
...
void CreateModel_quant8_4(Model *model) {
  OperandType type0(Type::TENSOR_FLOAT32, {300});
  OperandType type5(Type::TENSOR_QUANT8_ASYMM, {300}, 10.0f, 120);
  // Phase 1, operands
...
void CreateModel_quant8_6(Model *model) {
  ...
  auto output05 = model->addOperand(&type3);
  // Phase 2, operations
...
void CreateModel_quant8_7(Model *model) {
  ...
  auto output06 = model->addOperand(&type4);
  // Phase 2, operations
...
void CreateModel_quant8_8(Model *model) {
  ...
  auto output07 = model->addOperand(&type5);
  // Phase 2, operations
