...
void CreateModel_nhwc_none_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type16(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  OperandType type17(Type::TENSOR_FLOAT16, {2, 2, 2, 1});
...
void CreateModel_nhwc_none_float16_weight_as_input(Model *model) {
  ...
  OperandType type16(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  OperandType type19(Type::TENSOR_FLOAT16, {1, 2, 2, 2});
  OperandType type20(Type::TENSOR_FLOAT16, {2, 2, 2, 1});
...
void CreateModel_nchw_none(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type2(Type::TENSOR_FLOAT32, {2, 2, 2, 1});
  OperandType type22(Type::TENSOR_FLOAT32, {1, 2, 3, 3});
  OperandType type3(Type::TENSOR_FLOAT32, {2});
  OperandType type4(Type::INT32, {});
  OperandType type5(Type::TENSOR_FLOAT32, {1, 2, 2, 2});
  // Phase 1, operands
...
void CreateModel_nchw_none_quant8(Model *model) {
  ...
  OperandType type14(Type::TENSOR_INT32, {2}, 0.0625f, 0);
  OperandType type15(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 2}, 0.5f, 80);
  OperandType type23(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3, 3}, 0.25f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_dynamic_output_shape_nhwc_none_quant8(Model *model) {
  ...
  OperandType type13(Type::TENSOR_QUANT8_ASYMM, {2, 2, 2, 1}, 0.25f, 128);
  OperandType type14(Type::TENSOR_INT32, {2}, 0.0625f, 0);
  OperandType type26(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 0.5f, 80);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
  auto op1 = model->addOperand(&type12);
  auto op2 = model->addOperand(&type13);
...
void CreateModel_large_nhwc_quant8(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type28(Type::TENSOR_QUANT8_ASYMM, {1, 3, 2, 2}, 0.25f, 128);
  OperandType type29(Type::TENSOR_QUANT8_ASYMM, {2, 2, 3, 1}, 1.0f, 0);
  OperandType type30(Type::TENSOR_INT32, {2}, 0.25f, 0);
  OperandType type31(Type::TENSOR_QUANT8_ASYMM, {1, 3, 2, 2}, 10.0f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nhwc_float16(Model *model) {
  ...
  OperandType type33(Type::TENSOR_FLOAT16, {2, 2, 3, 1});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
  auto op11 = model->addOperand(&type32);
  auto op21 = model->addOperand(&type33);
  auto op31 = model->addOperand(&type18);
  auto param7 = model->addOperand(&type4);
  auto param8 = model->addOperand(&type4);
  auto param9 = model->addOperand(&type4);
  auto param10 = model->addOperand(&type4);
...
void CreateModel_large_nhwc_float16_weight_as_input(Model *model) {
  ...
  OperandType type21(Type::TENSOR_FLOAT16, {2});
  OperandType type32(Type::TENSOR_FLOAT16, {1, 3, 2, 2});
  OperandType type34(Type::TENSOR_FLOAT16, {2, 2, 3, 1});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
  auto op11 = model->addOperand(&type32);
...
void CreateModel_large_nchw(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type3(Type::TENSOR_FLOAT32, {2});
  OperandType type35(Type::TENSOR_FLOAT32, {1, 2, 3, 2});
  OperandType type4(Type::INT32, {});
  OperandType type7(Type::TENSOR_FLOAT32, {2, 2, 3, 1});
  // Phase 1, operands
...
void CreateModel_large_nchw_quant8(Model *model) {
  ...
  OperandType type29(Type::TENSOR_QUANT8_ASYMM, {2, 2, 3, 1}, 1.0f, 0);
  OperandType type30(Type::TENSOR_INT32, {2}, 0.25f, 0);
  OperandType type36(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3, 2}, 0.25f, 128);
  OperandType type37(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3, 2}, 10.0f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nchw_float16(Model *model) {
  ...
  OperandType type18(Type::TENSOR_FLOAT16, {2});
  OperandType type33(Type::TENSOR_FLOAT16, {2, 2, 3, 1});
  OperandType type38(Type::TENSOR_FLOAT16, {1, 2, 3, 2});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_dynamic_output_shape_nhwc_quant8(Model *model) {
  ...
  OperandType type29(Type::TENSOR_QUANT8_ASYMM, {2, 2, 3, 1}, 1.0f, 0);
  OperandType type30(Type::TENSOR_INT32, {2}, 0.25f, 0);
  OperandType type39(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 10.0f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
  auto op11 = model->addOperand(&type28);
  auto op21 = model->addOperand(&type29);
...
void CreateModel_channel_nhwc_quant8(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type4(Type::INT32, {});
  OperandType type40(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 9}, 0.5f, 0);
  OperandType type41(Type::TENSOR_QUANT8_ASYMM, {6, 1, 1, 3}, 0.25f, 0);
  OperandType type42(Type::TENSOR_INT32, {6}, 0.125f, 0);
  OperandType type43(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 6}, 2.0f, 60);
  // Phase 1, operands
...
void CreateModel_channel_nhwc_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type4(Type::INT32, {});
  OperandType type44(Type::TENSOR_FLOAT16, {1, 2, 2, 9});
  OperandType type45(Type::TENSOR_FLOAT16, {6, 1, 1, 3});
  OperandType type46(Type::TENSOR_FLOAT16, {6});
  OperandType type47(Type::TENSOR_FLOAT16, {1, 2, 2, 6});
  // Phase 1, operands
  auto op12 = model->addOperand(&type44);
  auto op22 = model->addOperand(&type45);
  auto op32 = model->addOperand(&type46);
  auto param12 = model->addOperand(&type4);
  auto param13 = model->addOperand(&type4);
  auto param14 = model->addOperand(&type4);
  auto param15 = model->addOperand(&type4);
...
void CreateModel_channel_nhwc_float16_weight_as_input(Model *model) {
  ...
  OperandType type44(Type::TENSOR_FLOAT16, {1, 2, 2, 9});
  OperandType type47(Type::TENSOR_FLOAT16, {1, 2, 2, 6});
  OperandType type48(Type::TENSOR_FLOAT16, {6, 1, 1, 3});
  OperandType type49(Type::TENSOR_FLOAT16, {6});
  // Phase 1, operands
  auto op12 = model->addOperand(&type44);
...
void CreateModel_channel_nchw(Model *model) {
  ...
  OperandType type10(Type::TENSOR_FLOAT32, {6});
  OperandType type4(Type::INT32, {});
  OperandType type50(Type::TENSOR_FLOAT32, {1, 9, 2, 2});
  OperandType type51(Type::TENSOR_FLOAT32, {1, 6, 2, 2});
  OperandType type9(Type::TENSOR_FLOAT32, {6, 1, 1, 3});
  // Phase 1, operands
...
void CreateModel_channel_nchw_quant8(Model *model) {
  ...
  OperandType type41(Type::TENSOR_QUANT8_ASYMM, {6, 1, 1, 3}, 0.25f, 0);
  OperandType type42(Type::TENSOR_INT32, {6}, 0.125f, 0);
  OperandType type52(Type::TENSOR_QUANT8_ASYMM, {1, 9, 2, 2}, 0.5f, 0);
  OperandType type53(Type::TENSOR_QUANT8_ASYMM, {1, 6, 2, 2}, 2.0f, 60);
  // Phase 1, operands
...
void CreateModel_channel_nchw_float16(Model *model) {
  ...
  OperandType type45(Type::TENSOR_FLOAT16, {6, 1, 1, 3});
  OperandType type46(Type::TENSOR_FLOAT16, {6});
  OperandType type54(Type::TENSOR_FLOAT16, {1, 9, 2, 2});
  OperandType type55(Type::TENSOR_FLOAT16, {1, 6, 2, 2});
  // Phase 1, operands
...
void CreateModel_channel_dynamic_output_shape_nhwc_quant8(Model *model) {
  ...
  OperandType type41(Type::TENSOR_QUANT8_ASYMM, {6, 1, 1, 3}, 0.25f, 0);
  OperandType type42(Type::TENSOR_INT32, {6}, 0.125f, 0);
  OperandType type56(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 2.0f, 60);
  // Phase 1, operands
  auto op12 = model->addOperand(&type40);
  auto op22 = model->addOperand(&type41);
  auto op32 = model->addOperand(&type42);
