...
void CreateModel_large_nhwc_quant8(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type25(Type::TENSOR_QUANT8_ASYMM, {1, 3, 2, 2}, 0.25f, 128);
  OperandType type26(Type::TENSOR_QUANT8_ASYMM, {2, 2, 3, 1}, 1.0f, 0);
  OperandType type27(Type::TENSOR_INT32, {2}, 0.25f, 0);
  OperandType type28(Type::TENSOR_QUANT8_ASYMM, {1, 3, 2, 2}, 10.0f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nhwc_float16(Model *model) {
  ...
  OperandType type30(Type::TENSOR_FLOAT16, {2, 2, 3, 1});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nhwc_float16_weight_as_input(Model *model) {
  ...
  OperandType type21(Type::TENSOR_FLOAT16, {2});
  OperandType type29(Type::TENSOR_FLOAT16, {1, 3, 2, 2});
  OperandType type31(Type::TENSOR_FLOAT16, {2, 2, 3, 1});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
  auto op11 = model->addOperand(&type29);
...
void CreateModel_large_nchw(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type3(Type::TENSOR_FLOAT32, {2});
  OperandType type32(Type::TENSOR_FLOAT32, {1, 2, 3, 2});
  OperandType type4(Type::INT32, {});
  OperandType type7(Type::TENSOR_FLOAT32, {2, 2, 3, 1});
  // Phase 1, operands
...
void CreateModel_large_nchw_quant8(Model *model) {
  ...
  OperandType type26(Type::TENSOR_QUANT8_ASYMM, {2, 2, 3, 1}, 1.0f, 0);
  OperandType type27(Type::TENSOR_INT32, {2}, 0.25f, 0);
  OperandType type33(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3, 2}, 0.25f, 128);
  OperandType type34(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3, 2}, 10.0f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nchw_float16(Model *model) {
  ...
  OperandType type18(Type::TENSOR_FLOAT16, {2});
  OperandType type30(Type::TENSOR_FLOAT16, {2, 2, 3, 1});
  OperandType type35(Type::TENSOR_FLOAT16, {1, 2, 3, 2});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_channel_nhwc_quant8(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type36(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 9}, 0.5f, 0);
  OperandType type37(Type::TENSOR_QUANT8_ASYMM, {6, 1, 1, 3}, 0.25f, 0);
  OperandType type38(Type::TENSOR_INT32, {6}, 0.125f, 0);
  OperandType type39(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 6}, 2.0f, 60);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
  auto op12 = model->addOperand(&type36);
  auto op22 = model->addOperand(&type37);
  auto op32 = model->addOperand(&type38);
  auto param12 = model->addOperand(&type4);
  auto param13 = model->addOperand(&type4);
  auto param14 = model->addOperand(&type4);
  auto param15 = model->addOperand(&type4);
...
void CreateModel_channel_nhwc_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type4(Type::INT32, {});
  OperandType type40(Type::TENSOR_FLOAT16, {1, 2, 2, 9});
  OperandType type41(Type::TENSOR_FLOAT16, {6, 1, 1, 3});
  OperandType type42(Type::TENSOR_FLOAT16, {6});
  OperandType type43(Type::TENSOR_FLOAT16, {1, 2, 2, 6});
  // Phase 1, operands
...
void CreateModel_channel_nhwc_float16_weight_as_input(Model *model) {
  ...
  OperandType type40(Type::TENSOR_FLOAT16, {1, 2, 2, 9});
  OperandType type43(Type::TENSOR_FLOAT16, {1, 2, 2, 6});
  OperandType type44(Type::TENSOR_FLOAT16, {6, 1, 1, 3});
  OperandType type45(Type::TENSOR_FLOAT16, {6});
  // Phase 1, operands
  auto op12 = model->addOperand(&type40);
...
void CreateModel_channel_nchw(Model *model) {
  ...
  OperandType type10(Type::TENSOR_FLOAT32, {6});
  OperandType type4(Type::INT32, {});
  OperandType type46(Type::TENSOR_FLOAT32, {1, 9, 2, 2});
  OperandType type47(Type::TENSOR_FLOAT32, {1, 6, 2, 2});
  OperandType type9(Type::TENSOR_FLOAT32, {6, 1, 1, 3});
  // Phase 1, operands
...
void CreateModel_channel_nchw_quant8(Model *model) {
  ...
  OperandType type38(Type::TENSOR_INT32, {6}, 0.125f, 0);
  OperandType type4(Type::INT32, {});
  OperandType type48(Type::TENSOR_QUANT8_ASYMM, {1, 9, 2, 2}, 0.5f, 0);
  OperandType type49(Type::TENSOR_QUANT8_ASYMM, {1, 6, 2, 2}, 2.0f, 60);
  // Phase 1, operands
...
void CreateModel_channel_nchw_float16(Model *model) {
  ...
  OperandType type41(Type::TENSOR_FLOAT16, {6, 1, 1, 3});
  OperandType type42(Type::TENSOR_FLOAT16, {6});
  OperandType type50(Type::TENSOR_FLOAT16, {1, 9, 2, 2});
  OperandType type51(Type::TENSOR_FLOAT16, {1, 6, 2, 2});
  // Phase 1, operands
