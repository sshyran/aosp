...
void CreateModel(Model *model) {
  OperandType type0(Type::TENSOR_FLOAT16, {3, 2, 5});
  OperandType type1(Type::TENSOR_FLOAT16, {4, 5});
  OperandType type10(Type::BOOL, {});
  OperandType type11(Type::TENSOR_FLOAT16, {2, 16});
  OperandType type12(Type::TENSOR_FLOAT16, {3, 2, 3});
  OperandType type2(Type::TENSOR_FLOAT16, {4, 3});
  OperandType type3(Type::TENSOR_FLOAT16, {4});
  OperandType type4(Type::TENSOR_FLOAT16, {3, 4});
  OperandType type5(Type::TENSOR_FLOAT16, {0});
  OperandType type6(Type::TENSOR_FLOAT16, {2, 3});
  OperandType type7(Type::TENSOR_FLOAT16, {2, 4});
...
void CreateModel_dynamic_output_shape(Model *model) {
  ...
  auto cell_layer_norm_weights = model->addOperand(&type3);
  auto output_layer_norm_weights = model->addOperand(&type3);
  auto scratch_buffer = model->addOperand(&type13);
  auto output_state_out = model->addOperand(&type13);
  auto cell_state_out = model->addOperand(&type13);
