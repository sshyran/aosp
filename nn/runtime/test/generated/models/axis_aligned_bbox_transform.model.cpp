...
void CreateModel_float16(Model *model) {
  OperandType type10(Type::TENSOR_FLOAT16, {5, 8});
  OperandType type11(Type::TENSOR_FLOAT16, {5, 3});
  OperandType type12(Type::TENSOR_FLOAT16, {4});
  OperandType type13(Type::TENSOR_FLOAT16, {5, 5});
  OperandType type3(Type::TENSOR_INT32, {5});
  OperandType type5(Type::BOOL, {});
  // Phase 1, operands
  auto roi = model->addOperand(&type13);
  auto bboxDeltas = model->addOperand(&type10);
  auto imageInfo = model->addOperand(&type11);
...
void CreateModel_float16_2(Model *model) {
  ...
  auto batchSplit = model->addOperand(&type3);
  // Phase 2, operations
  static _Float16 param2_init[] = {2.0f, 2.0f, 0.5f, 0.5f};
  model->setOperandValue(param2, param2_init, sizeof(_Float16) * 4);
  static bool8 param3_init[] = {true};
  model->setOperandValue(param3, param3_init, sizeof(bool8) * 1);
  model->addOperation(ANEURALNETWORKS_AXIS_ALIGNED_BBOX_TRANSFORM, {roi, bboxDeltas, imageInfo, param2, param3}, {out, batchSplit});
  // Phase 3, inputs and outputs
...
void CreateModel_single_batch_float16(Model *model) {
  OperandType type12(Type::TENSOR_FLOAT16, {4});
  OperandType type14(Type::TENSOR_FLOAT16, {2, 8});
  OperandType type15(Type::TENSOR_FLOAT16, {1, 3});
  ...
  auto batchSplit1 = model->addOperand(&type9);
  // Phase 2, operations
  static _Float16 param4_init[] = {2.0f, 2.0f, 0.5f, 0.5f};
  model->setOperandValue(param4, param4_init, sizeof(_Float16) * 4);
  static bool8 param5_init[] = {true};
  model->setOperandValue(param5, param5_init, sizeof(bool8) * 1);
  model->addOperation(ANEURALNETWORKS_AXIS_ALIGNED_BBOX_TRANSFORM, {roi1, bboxDeltas1, imageInfo1, param4, param5}, {out1, batchSplit1});
  // Phase 3, inputs and outputs
