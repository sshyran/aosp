...
void CreateModel_dynamic_output_shape_nhwc_none(Model *model) {
  ...
  OperandType type2(Type::TENSOR_FLOAT32, {2, 3, 3, 1});
  OperandType type3(Type::TENSOR_FLOAT32, {2});
  OperandType type31(Type::TENSOR_FLOAT32, {0, 0, 0, 0});
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type5(Type::INT32, {});
  // Phase 1, operands
  auto op1 = model->addOperand(&type1);
...
void CreateModel_nhwc_quant8(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type34(Type::TENSOR_QUANT8_ASYMM, {1, 1, 2, 1}, 2.0f, 0);
  OperandType type35(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 1}, 0.25f, 128);
  OperandType type36(Type::TENSOR_INT32, {1}, 0.5f, 0);
  OperandType type37(Type::TENSOR_QUANT8_ASYMM, {1, 3, 4, 1}, 20.0f, 50);
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type5(Type::INT32, {});
  // Phase 1, operands
  auto op11 = model->addOperand(&type34);
  auto op21 = model->addOperand(&type35);
  auto op31 = model->addOperand(&type36);
  auto shape1 = model->addOperand(&type4);
  auto param3 = model->addOperand(&type5);
  auto param4 = model->addOperand(&type5);
  auto param5 = model->addOperand(&type5);
...
void CreateModel_nhwc_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type38(Type::TENSOR_FLOAT16, {1, 1, 2, 1});
  OperandType type39(Type::TENSOR_FLOAT16, {1, 3, 3, 1});
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type40(Type::TENSOR_FLOAT16, {1});
  OperandType type41(Type::TENSOR_FLOAT16, {1, 3, 4, 1});
  OperandType type5(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nhwc_float16_weight_as_input(Model *model) {
  ...
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type41(Type::TENSOR_FLOAT16, {1, 3, 4, 1});
  OperandType type42(Type::TENSOR_FLOAT16, {1, 3, 3, 1});
  OperandType type43(Type::TENSOR_FLOAT16, {1});
  OperandType type5(Type::INT32, {});
  // Phase 1, operands
  auto op11 = model->addOperand(&type38);
  auto op21 = model->addOperand(&type42);
  auto op31 = model->addOperand(&type43);
  auto shape1 = model->addOperand(&type4);
  auto param3 = model->addOperand(&type5);
  auto param4 = model->addOperand(&type5);
  auto param5 = model->addOperand(&type5);
...
void CreateModel_nchw(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type44(Type::TENSOR_FLOAT32, {1, 1, 1, 2});
  OperandType type45(Type::TENSOR_FLOAT32, {1, 1, 3, 4});
  OperandType type5(Type::INT32, {});
  OperandType type8(Type::TENSOR_FLOAT32, {1, 3, 3, 1});
  OperandType type9(Type::TENSOR_FLOAT32, {1});
  // Phase 1, operands
  ...
  auto param6 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op41 = model->addOperand(&type45);
  // Phase 2, operations
  static float op21_init[] = {9.0f, 5.0f, 6.0f, 9.0f, 8.0f, 5.0f, 3.0f, 1.0f, 4.0f};
  model->setOperandValue(op21, op21_init, sizeof(float) * 9);
  static float op31_init[] = {-1000.0f};
...
void CreateModel_nchw_quant8(Model *model) {
  ...
  OperandType type36(Type::TENSOR_INT32, {1}, 0.5f, 0);
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type46(Type::TENSOR_QUANT8_ASYMM, {1, 1, 1, 2}, 2.0f, 0);
  OperandType type47(Type::TENSOR_QUANT8_ASYMM, {1, 1, 3, 4}, 20.0f, 50);
  OperandType type5(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nchw_float16(Model *model) {
  ...
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type40(Type::TENSOR_FLOAT16, {1});
  OperandType type48(Type::TENSOR_FLOAT16, {1, 1, 1, 2});
  OperandType type49(Type::TENSOR_FLOAT16, {1, 1, 3, 4});
  OperandType type5(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_dynamic_output_shape_nhwc_quant8(Model *model) {
  ...
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type5(Type::INT32, {});
  OperandType type50(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 20.0f, 50);
  // Phase 1, operands
  auto op11 = model->addOperand(&type34);
  auto op21 = model->addOperand(&type35);
  auto op31 = model->addOperand(&type36);
  ...
  auto param6 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op41 = model->addOperand(&type50);
  // Phase 2, operations
  static uint8_t op21_init[] = {164, 148, 152, 164, 160, 148, 140, 132, 144};
  model->setOperandValue(op21, op21_init, sizeof(uint8_t) * 9);
  static int32_t op31_init[] = {-2000};
...
void CreateModel_nhwc_quant8_2(Model *model) {
  ...
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type5(Type::INT32, {});
  OperandType type51(Type::TENSOR_QUANT8_ASYMM, {1, 4, 4, 2}, 0.5f, 100);
  OperandType type52(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 2}, 0.5f, 128);
  OperandType type53(Type::TENSOR_INT32, {1}, 0.25f, 0);
  OperandType type54(Type::TENSOR_QUANT8_ASYMM, {1, 4, 4, 1}, 16.0f, 0);
  // Phase 1, operands
...
void CreateModel_nhwc_float16_2(Model *model) {
  ...
  OperandType type40(Type::TENSOR_FLOAT16, {1});
  OperandType type5(Type::INT32, {});
  OperandType type55(Type::TENSOR_FLOAT16, {1, 4, 4, 2});
  OperandType type56(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  OperandType type57(Type::TENSOR_FLOAT16, {1, 4, 4, 1});
  // Phase 1, operands
  auto op12 = model->addOperand(&type55);
  auto op22 = model->addOperand(&type56);
...
void CreateModel_nhwc_float16_weight_as_input_2(Model *model) {
  ...
  OperandType type55(Type::TENSOR_FLOAT16, {1, 4, 4, 2});
  OperandType type57(Type::TENSOR_FLOAT16, {1, 4, 4, 1});
  OperandType type58(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  // Phase 1, operands
  auto op12 = model->addOperand(&type55);
  auto op22 = model->addOperand(&type58);
...
void CreateModel_nchw_2(Model *model) {
  ...
  OperandType type4(Type::TENSOR_INT32, {4});
  OperandType type5(Type::INT32, {});
  OperandType type59(Type::TENSOR_FLOAT32, {1, 2, 4, 4});
...
void CreateModel_nchw_quant8_2(Model *model) {
  ...
  OperandType type52(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 2}, 0.5f, 128);
  OperandType type53(Type::TENSOR_INT32, {1}, 0.25f, 0);
  OperandType type61(Type::TENSOR_QUANT8_ASYMM, {1, 2, 4, 4}, 0.5f, 100);
  OperandType type62(Type::TENSOR_QUANT8_ASYMM, {1, 1, 4, 4}, 16.0f, 0);
  // Phase 1, operands
  ...
  auto param10 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op42 = model->addOperand(&type62);
  // Phase 2, operations
  static uint8_t op22_init[] = {130, 132, 134, 136, 138, 140, 142, 144, 146, 148, 150, 152, 154, 156, 158, 160, 162, 164};
  model->setOperandValue(op22, op22_init, sizeof(uint8_t) * 18);
  static int32_t op32_init[] = {0};
...
void CreateModel_nchw_float16_2(Model *model) {
  ...
  OperandType type5(Type::INT32, {});
  OperandType type56(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  OperandType type63(Type::TENSOR_FLOAT16, {1, 2, 4, 4});
  OperandType type64(Type::TENSOR_FLOAT16, {1, 1, 4, 4});
  // Phase 1, operands
  auto op12 = model->addOperand(&type63);
  auto op22 = model->addOperand(&type56);
  auto op32 = model->addOperand(&type40);
  auto shape2 = model->addOperand(&type4);
  auto param7 = model->addOperand(&type5);
...
void CreateModel_dynamic_output_shape_nhwc_quant8_2(Model *model) {
  ...
  OperandType type52(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 2}, 0.5f, 128);
  OperandType type53(Type::TENSOR_INT32, {1}, 0.25f, 0);
  OperandType type65(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 16.0f, 0);
  // Phase 1, operands
  auto op12 = model->addOperand(&type51);
  auto op22 = model->addOperand(&type52);
  auto op32 = model->addOperand(&type53);
...
void CreateModel_nhwc_quant8_3(Model *model) {
  ...
  OperandType type5(Type::INT32, {});
  OperandType type52(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 2}, 0.5f, 128);
  OperandType type66(Type::TENSOR_QUANT8_ASYMM, {1, 4, 4, 2}, 0.25f, 10);
  OperandType type67(Type::TENSOR_INT32, {1}, 0.125f, 0);
  OperandType type68(Type::TENSOR_QUANT8_ASYMM, {1, 6, 6, 1}, 32.0f, 80);
  // Phase 1, operands
  auto op13 = model->addOperand(&type66);
  auto op23 = model->addOperand(&type52);
  auto op33 = model->addOperand(&type67);
  auto shape3 = model->addOperand(&type4);
  auto param11 = model->addOperand(&type5);
  auto param12 = model->addOperand(&type5);
  auto param13 = model->addOperand(&type5);
...
void CreateModel_nhwc_float16_3(Model *model) {
  ...
  OperandType type55(Type::TENSOR_FLOAT16, {1, 4, 4, 2});
  OperandType type56(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  OperandType type69(Type::TENSOR_FLOAT16, {1, 6, 6, 1});
  // Phase 1, operands
  auto op13 = model->addOperand(&type55);
  auto op23 = model->addOperand(&type56);
...
void CreateModel_nhwc_float16_weight_as_input_3(Model *model) {
  ...
  // Phase 1, operands
  auto op13 = model->addOperand(&type55);
  auto op23 = model->addOperand(&type58);
...
void CreateModel_nchw_3(Model *model) {
  ...
  OperandType type5(Type::INT32, {});
  OperandType type59(Type::TENSOR_FLOAT32, {1, 2, 4, 4});
  OperandType type70(Type::TENSOR_FLOAT32, {1, 1, 6, 6});
  OperandType type9(Type::TENSOR_FLOAT32, {1});
  // Phase 1, operands
...
void CreateModel_nchw_quant8_3(Model *model) {
  ...
  OperandType type52(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 2}, 0.5f, 128);
  OperandType type67(Type::TENSOR_INT32, {1}, 0.125f, 0);
  OperandType type71(Type::TENSOR_QUANT8_ASYMM, {1, 2, 4, 4}, 0.25f, 10);
  OperandType type72(Type::TENSOR_QUANT8_ASYMM, {1, 1, 6, 6}, 32.0f, 80);
  // Phase 1, operands
  auto op13 = model->addOperand(&type71);
  auto op23 = model->addOperand(&type52);
  auto op33 = model->addOperand(&type67);
  auto shape3 = model->addOperand(&type4);
  auto param11 = model->addOperand(&type5);
...
void CreateModel_nchw_float16_3(Model *model) {
  ...
  OperandType type56(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  OperandType type63(Type::TENSOR_FLOAT16, {1, 2, 4, 4});
  OperandType type73(Type::TENSOR_FLOAT16, {1, 1, 6, 6});
  // Phase 1, operands
...
void CreateModel_dynamic_output_shape_nhwc_3(Model *model) {
  ...
  auto param14 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op43 = model->addOperand(&type31);
  // Phase 2, operations
  static float op23_init[] = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f, 16.0f, 17.0f, 18.0f};
  model->setOperandValue(op23, op23_init, sizeof(float) * 18);
  static float op33_init[] = {0.0f};
...
void CreateModel_dynamic_output_shape_nhwc_quant8_3(Model *model) {
  ...
  OperandType type66(Type::TENSOR_QUANT8_ASYMM, {1, 4, 4, 2}, 0.25f, 10);
  OperandType type67(Type::TENSOR_INT32, {1}, 0.125f, 0);
  OperandType type74(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 32.0f, 80);
  // Phase 1, operands
  auto op13 = model->addOperand(&type66);
  auto op23 = model->addOperand(&type52);
  auto op33 = model->addOperand(&type67);
...
void CreateModel_dynamic_output_shape_nhwc_float16_3(Model *model) {
  ...
  auto param14 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op43 = model->addOperand(&type33);
  // Phase 2, operations
  static _Float16 op23_init[] = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f, 16.0f, 17.0f, 18.0f};
  model->setOperandValue(op23, op23_init, sizeof(_Float16) * 18);
  static _Float16 op33_init[] = {0.0f};
...
void CreateModel_nhwc_quant8_4(Model *model) {
  ...
  OperandType type51(Type::TENSOR_QUANT8_ASYMM, {1, 4, 4, 2}, 0.5f, 100);
  OperandType type67(Type::TENSOR_INT32, {1}, 0.125f, 0);
  OperandType type75(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 2}, 0.25f, 128);
  OperandType type76(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 1}, 20.0f, 50);
  // Phase 1, operands
  auto op14 = model->addOperand(&type51);
  auto op24 = model->addOperand(&type75);
  auto op34 = model->addOperand(&type67);
  auto param15 = model->addOperand(&type5);
  auto param16 = model->addOperand(&type5);
  auto param17 = model->addOperand(&type5);
  auto param18 = model->addOperand(&type5);
...
void CreateModel_nhwc_float16_4(Model *model) {
  ...
  auto op24 = model->addOperand(&type56);
...
void CreateModel_nhwc_float16_weight_as_input_4(Model *model) {
  ...
  // Phase 1, operands
  auto op14 = model->addOperand(&type55);
  auto op24 = model->addOperand(&type58);
  auto op34 = model->addOperand(&type43);
  auto param15 = model->addOperand(&type5);
  auto param16 = model->addOperand(&type5);
  auto param17 = model->addOperand(&type5);
  auto param18 = model->addOperand(&type5);
...
void CreateModel_nchw_4(Model *model) {
  ...
  OperandType type5(Type::INT32, {});
  OperandType type59(Type::TENSOR_FLOAT32, {1, 2, 4, 4});
  OperandType type77(Type::TENSOR_FLOAT32, {1, 1, 3, 3});
  OperandType type9(Type::TENSOR_FLOAT32, {1});
  // Phase 1, operands
...
void CreateModel_nchw_quant8_4(Model *model) {
  ...
  OperandType type67(Type::TENSOR_INT32, {1}, 0.125f, 0);
  OperandType type75(Type::TENSOR_QUANT8_ASYMM, {1, 3, 3, 2}, 0.25f, 128);
  OperandType type78(Type::TENSOR_QUANT8_ASYMM, {1, 1, 3, 3}, 20.0f, 50);
  // Phase 1, operands
...
void CreateModel_nchw_float16_4(Model *model) {
  ...
  OperandType type56(Type::TENSOR_FLOAT16, {1, 3, 3, 2});
  OperandType type63(Type::TENSOR_FLOAT16, {1, 2, 4, 4});
  OperandType type79(Type::TENSOR_FLOAT16, {1, 1, 3, 3});
  // Phase 1, operands
...
void CreateModel_dynamic_output_shape_nhwc_4(Model *model) {
  ...
  auto param21 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op44 = model->addOperand(&type31);
  // Phase 2, operations
  static float op24_init[] = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f, 16.0f, 17.0f, 18.0f};
  model->setOperandValue(op24, op24_init, sizeof(float) * 18);
  static float op34_init[] = {0.0f};
...
void CreateModel_dynamic_output_shape_nhwc_quant8_4(Model *model) {
  ...
  auto param21 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op44 = model->addOperand(&type50);
  // Phase 2, operations
  static uint8_t op24_init[] = {132, 136, 140, 144, 148, 152, 156, 160, 164, 168, 172, 176, 180, 184, 188, 192, 196, 200};
  model->setOperandValue(op24, op24_init, sizeof(uint8_t) * 18);
  static int32_t op34_init[] = {0};
...
void CreateModel_dynamic_output_shape_nhwc_float16_4(Model *model) {
  ...
  auto param21 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto op44 = model->addOperand(&type33);
  // Phase 2, operations
  static _Float16 op24_init[] = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f, 16.0f, 17.0f, 18.0f};
  model->setOperandValue(op24, op24_init, sizeof(_Float16) * 18);
  static _Float16 op34_init[] = {0.0f};
