...
void CreateModel_nhwc_float16_4(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type19(Type::FLOAT16, {});
  OperandType type48(Type::TENSOR_FLOAT16, {4, 4, 4, 1});
  OperandType type49(Type::TENSOR_FLOAT16, {5, 2, 2, 1});
  OperandType type5(Type::INT32, {});
  OperandType type50(Type::TENSOR_FLOAT16, {5, 4});
  OperandType type9(Type::TENSOR_INT32, {4});
  // Phase 1, operands
  auto in3 = model->addOperand(&type48);
  auto roi3 = model->addOperand(&type50);
  auto param21 = model->addOperand(&type9);
  auto param22 = model->addOperand(&type5);
  auto param23 = model->addOperand(&type5);
  ...
  auto param27 = model->addOperand(&type5);
  auto layout = model->addOperand(&type0);
  auto out3 = model->addOperand(&type49);
  // Phase 2, operations
  static int32_t param21_init[] = {0, 0, 5, 0};
  model->setOperandValue(param21, param21_init, sizeof(int32_t) * 4);
  static int32_t param22_init[] = {2};
...
void CreateModel_nchw_4(Model *model) {
  ...
  OperandType type13(Type::TENSOR_FLOAT32, {5, 4});
  OperandType type5(Type::INT32, {});
  OperandType type51(Type::TENSOR_FLOAT32, {4, 1, 4, 4});
  OperandType type52(Type::TENSOR_FLOAT32, {5, 1, 2, 2});
  OperandType type6(Type::FLOAT32, {});
  OperandType type9(Type::TENSOR_INT32, {4});
  // Phase 1, operands
...
void CreateModel_nchw_quant8_4(Model *model) {
  ...
  OperandType type13(Type::TENSOR_FLOAT32, {5, 4});
  OperandType type5(Type::INT32, {});
  OperandType type53(Type::TENSOR_QUANT8_ASYMM, {4, 1, 4, 4}, 0.25f, 128);
  OperandType type54(Type::TENSOR_QUANT8_ASYMM, {5, 1, 2, 2}, 0.0625f, 128);
  OperandType type6(Type::FLOAT32, {});
  OperandType type9(Type::TENSOR_INT32, {4});
  // Phase 1, operands
  auto in3 = model->addOperand(&type53);
  auto roi3 = model->addOperand(&type13);
  auto param21 = model->addOperand(&type9);
  auto param22 = model->addOperand(&type5);
  auto param23 = model->addOperand(&type5);
...
void CreateModel_nchw_float16_4(Model *model) {
  ...
  OperandType type5(Type::INT32, {});
  OperandType type50(Type::TENSOR_FLOAT16, {5, 4});
  OperandType type55(Type::TENSOR_FLOAT16, {4, 1, 4, 4});
  OperandType type56(Type::TENSOR_FLOAT16, {5, 1, 2, 2});
  OperandType type9(Type::TENSOR_INT32, {4});
  // Phase 1, operands
  auto in3 = model->addOperand(&type55);
  auto roi3 = model->addOperand(&type50);
  auto param21 = model->addOperand(&type9);
  auto param22 = model->addOperand(&type5);
  auto param23 = model->addOperand(&type5);
