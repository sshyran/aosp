...
void CreateModel_nchw_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type2(Type::INT32, {});
  OperandType type9(Type::TENSOR_FLOAT16, {1, 1, 2, 2});
  // Phase 1, operands
...
void CreateModel_nhwc_float16_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type12(Type::TENSOR_FLOAT16, {1, 2, 4, 1});
  OperandType type13(Type::TENSOR_FLOAT16, {1, 1, 2, 1});
  OperandType type2(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nchw_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type14(Type::TENSOR_FLOAT32, {1, 1, 2, 4});
  OperandType type15(Type::TENSOR_FLOAT32, {1, 1, 1, 2});
  OperandType type2(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nchw_float16_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type16(Type::TENSOR_FLOAT16, {1, 1, 2, 4});
  OperandType type17(Type::TENSOR_FLOAT16, {1, 1, 1, 2});
  OperandType type2(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nhwc_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type18(Type::TENSOR_FLOAT16, {1, 2, 2, 3});
  OperandType type19(Type::TENSOR_FLOAT16, {1, 1, 1, 3});
  OperandType type2(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nchw(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type2(Type::INT32, {});
  OperandType type20(Type::TENSOR_FLOAT32, {1, 3, 2, 2});
  OperandType type21(Type::TENSOR_FLOAT32, {1, 3, 1, 1});
  // Phase 1, operands
...
void CreateModel_large_nchw_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type2(Type::INT32, {});
  OperandType type22(Type::TENSOR_FLOAT16, {1, 3, 2, 2});
  OperandType type23(Type::TENSOR_FLOAT16, {1, 3, 1, 1});
  // Phase 1, operands
