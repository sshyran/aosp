...
void CreateModel_nhwc_float16_2(Model *model) {
  ...
  OperandType type12(Type::TENSOR_FLOAT16, {1, 2, 2, 4});
  OperandType type13(Type::TENSOR_FLOAT16, {4});
  OperandType type26(Type::TENSOR_FLOAT16, {1, 3, 2, 2});
  OperandType type27(Type::TENSOR_FLOAT16, {1, 2, 1, 4});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nhwc_quant8_2(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type28(Type::TENSOR_QUANT8_ASYMM, {1, 3, 2, 2}, 0.5f, 128);
  OperandType type29(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 4}, 0.5f, 128);
  OperandType type30(Type::TENSOR_INT32, {4}, 0.25f, 0);
  OperandType type31(Type::TENSOR_QUANT8_ASYMM, {1, 2, 1, 4}, 1.0f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nhwc_channelQuant8_2(Model *model) {
  ...
  OperandType type28(Type::TENSOR_QUANT8_ASYMM, {1, 3, 2, 2}, 0.5f, 128);
  OperandType type31(Type::TENSOR_QUANT8_ASYMM, {1, 2, 1, 4}, 1.0f, 100);
  OperandType type32(Type::TENSOR_QUANT8_SYMM_PER_CHANNEL, {1, 2, 2, 4}, 0.0f, 0, SymmPerChannelQuantParams({0.5f, 0.25f, 0.5f, 0.25f},3));
  OperandType type33(Type::TENSOR_INT32, {4}, 0.0f, 0);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
  auto op11 = model->addOperand(&type28);
...
void CreateModel_nchw_2(Model *model) {
  ...
  OperandType type2(Type::TENSOR_FLOAT32, {1, 2, 2, 4});
  OperandType type3(Type::TENSOR_FLOAT32, {4});
  OperandType type34(Type::TENSOR_FLOAT32, {1, 2, 3, 2});
  OperandType type35(Type::TENSOR_FLOAT32, {1, 4, 2, 1});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nchw_float16_2(Model *model) {
  ...
  OperandType type12(Type::TENSOR_FLOAT16, {1, 2, 2, 4});
  OperandType type13(Type::TENSOR_FLOAT16, {4});
  OperandType type36(Type::TENSOR_FLOAT16, {1, 2, 3, 2});
  OperandType type37(Type::TENSOR_FLOAT16, {1, 4, 2, 1});
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_nchw_quant8_2(Model *model) {
  ...
  OperandType type29(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 4}, 0.5f, 128);
  OperandType type30(Type::TENSOR_INT32, {4}, 0.25f, 0);
  OperandType type38(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3, 2}, 0.5f, 128);
  OperandType type39(Type::TENSOR_QUANT8_ASYMM, {1, 4, 2, 1}, 1.0f, 100);
  OperandType type4(Type::INT32, {});
  // Phase 1, operands
...
void CreateModel_large_nhwc_float16(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type4(Type::INT32, {});
  OperandType type40(Type::TENSOR_FLOAT16, {1, 2, 2, 2});
  OperandType type41(Type::TENSOR_FLOAT16, {2});
  OperandType type42(Type::TENSOR_FLOAT16, {1, 1, 1, 2});
  // Phase 1, operands
...
void CreateModel_large_nhwc_quant8(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type4(Type::INT32, {});
  OperandType type43(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 2}, 0.5f, 100);
  OperandType type44(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 2}, 0.125f, 128);
  OperandType type45(Type::TENSOR_INT32, {2}, 0.0625f, 0);
  OperandType type46(Type::TENSOR_QUANT8_ASYMM, {1, 1, 1, 2}, 2.0f, 128);
  // Phase 1, operands
...
void CreateModel_large_nhwc_channelQuant8(Model *model) {
  ...
  OperandType type4(Type::INT32, {});
  OperandType type46(Type::TENSOR_QUANT8_ASYMM, {1, 1, 1, 2}, 2.0f, 128);
  OperandType type47(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 2}, 0.5f, 128);
  OperandType type48(Type::TENSOR_QUANT8_SYMM_PER_CHANNEL, {1, 2, 2, 2}, 0.0f, 0, SymmPerChannelQuantParams({0.125f, 0.25f},3));
...
void CreateModel_large_nchw(Model *model) {
  OperandType type0(Type::BOOL, {});
  OperandType type4(Type::INT32, {});
  OperandType type50(Type::TENSOR_FLOAT32, {1, 2, 1, 1});
  OperandType type7(Type::TENSOR_FLOAT32, {1, 2, 2, 2});
  OperandType type8(Type::TENSOR_FLOAT32, {2});
  // Phase 1, operands
  auto op12 = model->addOperand(&type7);
...
void CreateModel_large_nchw_float16(Model *model) {
  ...
  OperandType type40(Type::TENSOR_FLOAT16, {1, 2, 2, 2});
  OperandType type41(Type::TENSOR_FLOAT16, {2});
  OperandType type51(Type::TENSOR_FLOAT16, {1, 2, 1, 1});
  // Phase 1, operands
  auto op12 = model->addOperand(&type40);
  auto op22 = model->addOperand(&type40);
  auto op32 = model->addOperand(&type41);
...
void CreateModel_large_nchw_quant8(Model *model) {
  ...
  OperandType type44(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 2}, 0.125f, 128);
  OperandType type45(Type::TENSOR_INT32, {2}, 0.0625f, 0);
  OperandType type52(Type::TENSOR_QUANT8_ASYMM, {1, 2, 1, 1}, 2.0f, 128);
  // Phase 1, operands
  auto op12 = model->addOperand(&type43);
  auto op22 = model->addOperand(&type44);
  auto op32 = model->addOperand(&type45);
  ...
  auto param20 = model->addOperand(&type4);
  auto layout = model->addOperand(&type0);
  auto op42 = model->addOperand(&type52);
  // Phase 2, operations
  static uint8_t op22_init[] = {130, 128, 130, 136, 130, 128, 130, 136};
  model->setOperandValue(op22, op22_init, sizeof(uint8_t) * 8);
  static int32_t op32_init[] = {1600, 3200};
...
void CreateModel_large_nhwc_float16_2(Model *model) {
  ...
  OperandType type13(Type::TENSOR_FLOAT16, {4});
  OperandType type4(Type::INT32, {});
  OperandType type53(Type::TENSOR_FLOAT16, {1, 1, 1, 4});
  // Phase 1, operands
...
void CreateModel_large_nhwc_quant8_2(Model *model) {
  ...
  OperandType type29(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 4}, 0.5f, 128);
  OperandType type4(Type::INT32, {});
  OperandType type54(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 4}, 0.25f, 0);
  OperandType type55(Type::TENSOR_INT32, {4}, 0.125f, 0);
  OperandType type56(Type::TENSOR_QUANT8_ASYMM, {1, 1, 1, 4}, 50.0f, 0);
  // Phase 1, operands
  auto op13 = model->addOperand(&type29);
  auto op23 = model->addOperand(&type54);
  auto op33 = model->addOperand(&type55);
  auto param21 = model->addOperand(&type4);
  auto param22 = model->addOperand(&type4);
  auto param23 = model->addOperand(&type4);
  auto param24 = model->addOperand(&type4);
  ...
  auto param28 = model->addOperand(&type4);
  auto layout = model->addOperand(&type0);
  auto op43 = model->addOperand(&type56);
  // Phase 2, operations
...
void CreateModel_large_nhwc_channelQuant8_2(Model *model) {
  ...
  OperandType type4(Type::INT32, {});
  OperandType type56(Type::TENSOR_QUANT8_ASYMM, {1, 1, 1, 4}, 50.0f, 0);
  OperandType type57(Type::TENSOR_QUANT8_SYMM_PER_CHANNEL, {1, 2, 2, 4}, 0.0f, 0, SymmPerChannelQuantParams({1.0f, 2.0f, 1.0f, 1.0f},3));
  OperandType type58(Type::TENSOR_INT32, {4}, 0.0f, 0);
  // Phase 1, operands
  auto op13 = model->addOperand(&type29);
  auto op23 = model->addOperand(&type57);
  auto op33 = model->addOperand(&type58);
  auto param21 = model->addOperand(&type4);
  auto param22 = model->addOperand(&type4);
  auto param23 = model->addOperand(&type4);
  auto param24 = model->addOperand(&type4);
...
void CreateModel_large_nchw_2(Model *model) {
  ...
  OperandType type3(Type::TENSOR_FLOAT32, {4});
  OperandType type4(Type::INT32, {});
  OperandType type59(Type::TENSOR_FLOAT32, {1, 4, 1, 1});
  // Phase 1, operands
...
void CreateModel_large_nchw_float16_2(Model *model) {
  ...
  OperandType type23(Type::TENSOR_FLOAT16, {1, 4, 2, 2});
  OperandType type4(Type::INT32, {});
  OperandType type60(Type::TENSOR_FLOAT16, {1, 4, 1, 1});
  // Phase 1, operands
...
void CreateModel_large_nchw_quant8_2(Model *model) {
  ...
  OperandType type54(Type::TENSOR_QUANT8_ASYMM, {1, 2, 2, 4}, 0.25f, 0);
  OperandType type55(Type::TENSOR_INT32, {4}, 0.125f, 0);
  OperandType type61(Type::TENSOR_QUANT8_ASYMM, {1, 4, 2, 2}, 0.5f, 128);
  OperandType type62(Type::TENSOR_QUANT8_ASYMM, {1, 4, 1, 1}, 50.0f, 0);
  // Phase 1, operands
