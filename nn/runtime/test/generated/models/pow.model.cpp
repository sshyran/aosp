...
void CreateModel_float16_2(Model *model) {
  OperandType type6(Type::TENSOR_FLOAT16, {2, 1});
  OperandType type8(Type::TENSOR_FLOAT16, {1, 2});
  OperandType type9(Type::TENSOR_FLOAT16, {2, 2});
  // Phase 1, operands
  auto base = model->addOperand(&type6);
  auto exponent1 = model->addOperand(&type8);
...
void CreateModel_float16_3(Model *model) {
  OperandType type10(Type::TENSOR_FLOAT16, {3, 1, 2});
  OperandType type11(Type::TENSOR_FLOAT16, {3, 2, 2});
  OperandType type6(Type::TENSOR_FLOAT16, {2, 1});
  // Phase 1, operands
  auto base = model->addOperand(&type6);
  auto exponent2 = model->addOperand(&type10);
