...
Model createTestModel_nhwc() {
    ...
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 63, 0, 0, 0, 63, 4, 0, 0, 0, 4, 0, 0, 0, 0
    };
...
Model createTestModel_nhwc_float16() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 56, 0, 56, 4, 0, 0, 0, 4, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 63, 0, 0, 0, 63, 4, 0, 0, 0, 4, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw_float16() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 56, 0, 56, 4, 0, 0, 0, 4, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nhwc_2() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 0, 128, 62, 0, 0, 128, 62, 4, 0, 0, 0, 4, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nhwc_float16_2() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 52, 0, 52, 4, 0, 0, 0, 4, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw_2() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 0, 128, 62, 0, 0, 128, 62, 4, 0, 0, 0, 4, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw_float16_2() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 52, 0, 52, 4, 0, 0, 0, 4, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nhwc_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 0, 128, 62, 0, 0, 128, 62, 0, 0, 0, 0, 0, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nhwc_float16_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 52, 0, 52, 0, 0, 0, 0, 0, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 0, 128, 62, 0, 0, 128, 62, 0, 0, 0, 0, 0, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw_float16_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 3, 0, 0, 0, 0, 52, 0, 52, 0, 0, 0, 0, 0, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nhwc_4() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 63, 0, 0, 128, 63, 0, 0, 0, 0, 4, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nhwc_float16_4() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 56, 0, 60, 0, 0, 0, 0, 4, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw_4() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 63, 0, 0, 128, 63, 0, 0, 0, 0, 4, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_nchw_float16_4() {
    ...
    const std::vector<uint32_t> outputIndexes = {9};
    std::vector<uint8_t> operandValues = {
      2, 0, 0, 0, 2, 0, 0, 0, 0, 56, 0, 60, 0, 0, 0, 0, 4, 0, 0, 0, 1
    };
    const std::vector<hidl_memory> pools = {};
