...
Model createTestModel() {
    const std::vector<Operand> operands = {
        ...
        },
        {
            ...
            .zeroPoint = 0,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 17, .length = 1},
        },
        {
    ...
    const std::vector<Operation> operations = {
        {
            .type = OperationType::ROTATED_BBOX_TRANSFORM,
    ...
    const std::vector<uint32_t> outputIndexes = {9, 10};
    std::vector<uint8_t> operandValues = {
      0, 0, 0, 64, 0, 0, 0, 64, 0, 0, 0, 63, 0, 0, 0, 63, 0, 1, 166, 255, 255, 255, 90, 0, 0, 0, 0, 0, 128, 63
    };
...
Model createTestModel_float16() {
    ...
    const std::vector<uint32_t> outputIndexes = {9, 10};
    std::vector<uint8_t> operandValues = {
      0, 64, 0, 64, 0, 56, 0, 56, 0, 1, 166, 255, 255, 255, 90, 0, 0, 0, 0, 60
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_2() {
    ...
    const std::vector<uint32_t> outputIndexes = {9, 10};
    std::vector<uint8_t> operandValues = {
      0, 0, 0, 64, 0, 0, 0, 64, 0, 0, 0, 63, 0, 0, 0, 63, 1, 0, 166, 255, 255, 255, 90, 0, 0, 0, 0, 0, 128, 63
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_float16_2() {
    ...
    const std::vector<uint32_t> outputIndexes = {9, 10};
    std::vector<uint8_t> operandValues = {
      0, 64, 0, 64, 0, 56, 0, 56, 1, 0, 166, 255, 255, 255, 90, 0, 0, 0, 0, 60
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {9, 10};
    std::vector<uint8_t> operandValues = {
      0, 0, 0, 64, 0, 0, 0, 64, 0, 0, 0, 63, 0, 0, 0, 63, 1, 1, 166, 255, 255, 255, 90, 0, 0, 0, 0, 0, 128, 191
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_float16_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {9, 10};
    std::vector<uint8_t> operandValues = {
      0, 64, 0, 64, 0, 56, 0, 56, 1, 1, 166, 255, 255, 255, 90, 0, 0, 0, 0, 188
    };
    const std::vector<hidl_memory> pools = {};
