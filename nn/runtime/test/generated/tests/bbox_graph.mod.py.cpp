...
TEST_AVAILABLE_SINCE(V1_2, bbox_graph_zero_sized, generated_tests::bbox_graph::CreateModel_zero_sized)
...
TEST_AVAILABLE_SINCE(V1_2, bbox_graph_zero_sized_float16, generated_tests::bbox_graph::CreateModel_zero_sized_float16)
...
TEST_AVAILABLE_SINCE(V1_2, bbox_graph_zero_sized_quant8, generated_tests::bbox_graph::CreateModel_zero_sized_quant8)
