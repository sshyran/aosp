...
#if 0
TEST_F(DynamicOutputShapeTests, lstm3_float16_dynamic_output_shape) {
    execute(lstm3_float16::CreateModel_dynamic_output_shape,
            lstm3_float16::is_ignored_dynamic_output_shape,
            lstm3_float16::get_examples_dynamic_output_shape());
}
