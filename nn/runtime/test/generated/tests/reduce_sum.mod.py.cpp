...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum, generated_tests::reduce_sum::CreateModel)
...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum_float16, generated_tests::reduce_sum::CreateModel_float16)
...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum_2, generated_tests::reduce_sum::CreateModel_2)
...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum_float16_2, generated_tests::reduce_sum::CreateModel_float16_2)
...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum_3, generated_tests::reduce_sum::CreateModel_3)
...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum_float16_3, generated_tests::reduce_sum::CreateModel_float16_3)
...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum_4, generated_tests::reduce_sum::CreateModel_4)
...
TEST_AVAILABLE_SINCE(V1_2, reduce_sum_float16_4, generated_tests::reduce_sum::CreateModel_float16_4)
