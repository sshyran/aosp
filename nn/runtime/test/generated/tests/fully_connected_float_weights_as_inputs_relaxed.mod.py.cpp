...
#if 0
TEST_F(DynamicOutputShapeTests, fully_connected_float_weights_as_inputs_relaxed_dynamic_output_shape) {
    execute(fully_connected_float_weights_as_inputs_relaxed::CreateModel_dynamic_output_shape,
            fully_connected_float_weights_as_inputs_relaxed::is_ignored_dynamic_output_shape,
            fully_connected_float_weights_as_inputs_relaxed::get_examples_dynamic_output_shape());
}
