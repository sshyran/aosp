...
#if 0
TEST_F(DynamicOutputShapeTests, l2_pool_float_large_relaxed_dynamic_output_shape) {
    execute(l2_pool_float_large_relaxed::CreateModel_dynamic_output_shape,
            l2_pool_float_large_relaxed::is_ignored_dynamic_output_shape,
            l2_pool_float_large_relaxed::get_examples_dynamic_output_shape());
}
