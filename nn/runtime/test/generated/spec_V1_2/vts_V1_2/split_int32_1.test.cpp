...
TEST_F(DynamicOutputShapeTest, split_int32_1_dynamic_output_shape_relaxed) {
  Execute(device,
          ...
          ::generated_tests::split_int32_1::get_examples_dynamic_output_shape_relaxed(), true);
}
...
TEST_F(ValidationTest, split_int32_1_dynamic_output_shape_relaxed) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::split_int32_1::get_examples_dynamic_output_shape_relaxed());
  validateEverything(model, requests);
}
