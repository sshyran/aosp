...
TEST_F(NeuralnetworksHidlTest, gather_higher_rank_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal,
          is_ignored_all_inputs_as_internal,
          ::generated_tests::gather_higher_rank::get_examples_all_inputs_as_internal());
}

TEST_F(ValidationTest, gather_higher_rank_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, gather_higher_rank_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::gather_higher_rank::get_examples_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, gather_higher_rank_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, gather_higher_rank_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape,
          is_ignored_relaxed_dynamic_output_shape,
          ::generated_tests::gather_higher_rank::get_examples_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, gather_higher_rank_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, gather_higher_rank_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal,
          is_ignored_relaxed_all_inputs_as_internal,
          ::generated_tests::gather_higher_rank::get_examples_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, gather_higher_rank_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, gather_higher_rank_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::gather_higher_rank::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, gather_higher_rank_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, gather_higher_rank_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_quant8_dynamic_output_shape,
          is_ignored_quant8_dynamic_output_shape,
          ::generated_tests::gather_higher_rank::get_examples_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, gather_higher_rank_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, gather_higher_rank_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal,
          is_ignored_quant8_all_inputs_as_internal,
          ::generated_tests::gather_higher_rank::get_examples_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, gather_higher_rank_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, gather_higher_rank_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::gather_higher_rank::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, gather_higher_rank_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, gather_higher_rank_int32_dynamic_output_shape) {
  Execute(device,
          createTestModel_int32_dynamic_output_shape,
          is_ignored_int32_dynamic_output_shape,
          ::generated_tests::gather_higher_rank::get_examples_int32_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, gather_higher_rank_int32_dynamic_output_shape) {
  const Model model = createTestModel_int32_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::gather_higher_rank::get_examples_int32_dynamic_output_shape());
  validateEverything(model, requests);
}
