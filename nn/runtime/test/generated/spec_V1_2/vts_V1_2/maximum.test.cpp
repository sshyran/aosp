...
TEST_F(NeuralnetworksHidlTest, maximum_simple_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal,
          is_ignored_all_inputs_as_internal,
          ::generated_tests::maximum::get_examples_simple_all_inputs_as_internal());
}

TEST_F(ValidationTest, maximum_simple_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::maximum::get_examples_simple_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape,
          is_ignored_relaxed_dynamic_output_shape,
          ::generated_tests::maximum::get_examples_simple_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_simple_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal,
          is_ignored_relaxed_all_inputs_as_internal,
          ::generated_tests::maximum::get_examples_simple_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, maximum_simple_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::maximum::get_examples_simple_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape,
          is_ignored_float16_dynamic_output_shape,
          ::generated_tests::maximum::get_examples_simple_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_simple_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal,
          is_ignored_float16_all_inputs_as_internal,
          ::generated_tests::maximum::get_examples_simple_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, maximum_simple_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::maximum::get_examples_simple_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_int32_dynamic_output_shape) {
  Execute(device,
          createTestModel_int32_dynamic_output_shape,
          is_ignored_int32_dynamic_output_shape,
          ::generated_tests::maximum::get_examples_simple_int32_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_int32_dynamic_output_shape) {
  const Model model = createTestModel_int32_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_int32_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_quant8_dynamic_output_shape,
          is_ignored_quant8_dynamic_output_shape,
          ::generated_tests::maximum::get_examples_simple_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_simple_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal,
          is_ignored_quant8_all_inputs_as_internal,
          ::generated_tests::maximum::get_examples_simple_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, maximum_simple_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_simple_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::maximum::get_examples_simple_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_simple_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_simple_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_broadcast_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal_2,
          is_ignored_all_inputs_as_internal_2,
          ::generated_tests::maximum::get_examples_broadcast_all_inputs_as_internal());
}

TEST_F(ValidationTest, maximum_broadcast_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_2,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_2,
          ::generated_tests::maximum::get_examples_broadcast_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_2,
          is_ignored_relaxed_dynamic_output_shape_2,
          ::generated_tests::maximum::get_examples_broadcast_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_broadcast_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_2,
          is_ignored_relaxed_all_inputs_as_internal_2,
          ::generated_tests::maximum::get_examples_broadcast_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, maximum_broadcast_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::maximum::get_examples_broadcast_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_2,
          is_ignored_float16_dynamic_output_shape_2,
          ::generated_tests::maximum::get_examples_broadcast_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_broadcast_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_2,
          is_ignored_float16_all_inputs_as_internal_2,
          ::generated_tests::maximum::get_examples_broadcast_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, maximum_broadcast_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::maximum::get_examples_broadcast_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_int32_dynamic_output_shape) {
  Execute(device,
          createTestModel_int32_dynamic_output_shape_2,
          is_ignored_int32_dynamic_output_shape_2,
          ::generated_tests::maximum::get_examples_broadcast_int32_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_int32_dynamic_output_shape) {
  const Model model = createTestModel_int32_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_int32_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_quant8_dynamic_output_shape_2,
          is_ignored_quant8_dynamic_output_shape_2,
          ::generated_tests::maximum::get_examples_broadcast_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_quant8_dynamic_output_shape) {
  const Model model = createTestModel_quant8_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_broadcast_quant8_all_inputs_as_internal) {
  Execute(device,
          createTestModel_quant8_all_inputs_as_internal_2,
          is_ignored_quant8_all_inputs_as_internal_2,
          ::generated_tests::maximum::get_examples_broadcast_quant8_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, maximum_broadcast_quant8_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_quant8_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_broadcast_quant8_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::maximum::get_examples_broadcast_quant8_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_broadcast_quant8_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_quant8_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_broadcast_quant8_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, maximum_overflow_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal_3,
          is_ignored_all_inputs_as_internal_3,
          ::generated_tests::maximum::get_examples_overflow_all_inputs_as_internal());
}

TEST_F(ValidationTest, maximum_overflow_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal_3();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_overflow_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, maximum_overflow_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_3,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_3,
          ::generated_tests::maximum::get_examples_overflow_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, maximum_overflow_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::maximum::get_examples_overflow_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
