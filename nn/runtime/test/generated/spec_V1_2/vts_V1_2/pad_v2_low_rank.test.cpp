...
TEST_F(DynamicOutputShapeTest, pad_v2_low_rank_dynamic_output_shape_float16) {
  Execute(device,
          ...
          ::generated_tests::pad_v2_low_rank::get_examples_dynamic_output_shape_float16(), true);
}
...
TEST_F(ValidationTest, pad_v2_low_rank_dynamic_output_shape_float16) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::pad_v2_low_rank::get_examples_dynamic_output_shape_float16());
  validateEverything(model, requests);
}
