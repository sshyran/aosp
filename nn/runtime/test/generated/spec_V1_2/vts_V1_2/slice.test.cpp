...
TEST_F(NeuralnetworksHidlTest, slice_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal,
          is_ignored_all_inputs_as_internal,
          ::generated_tests::slice::get_examples_all_inputs_as_internal());
}

TEST_F(ValidationTest, slice_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape,
          is_ignored_relaxed_dynamic_output_shape,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal,
          is_ignored_relaxed_all_inputs_as_internal,
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape,
          is_ignored_float16_dynamic_output_shape,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal,
          is_ignored_float16_all_inputs_as_internal,
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, slice_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_all_inputs_as_internal_2,
          is_ignored_all_inputs_as_internal_2,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_2());
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_2) {
  const Model model = createTestModel_all_inputs_as_internal_2();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_2,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_2,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_2,
          is_ignored_relaxed_dynamic_output_shape_2,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape_2) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_relaxed_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_2,
          is_ignored_relaxed_all_inputs_as_internal_2,
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_2,
          is_ignored_float16_dynamic_output_shape_2,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape_2) {
  const Model model = createTestModel_float16_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_float16_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_2,
          is_ignored_float16_all_inputs_as_internal_2,
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_all_inputs_as_internal_3,
          is_ignored_all_inputs_as_internal_3,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_3());
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_3) {
  const Model model = createTestModel_all_inputs_as_internal_3();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_3,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_3,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape_3) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_3,
          is_ignored_relaxed_dynamic_output_shape_3,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape_3) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_relaxed_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_3,
          is_ignored_relaxed_all_inputs_as_internal_3,
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape_3) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_3,
          is_ignored_float16_dynamic_output_shape_3,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape_3) {
  const Model model = createTestModel_float16_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_float16_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_3,
          is_ignored_float16_all_inputs_as_internal_3,
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_all_inputs_as_internal_4) {
  Execute(device,
          createTestModel_all_inputs_as_internal_4,
          is_ignored_all_inputs_as_internal_4,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_4());
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_4) {
  const Model model = createTestModel_all_inputs_as_internal_4();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_all_inputs_as_internal_dynamic_output_shape_4) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_4,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_4,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_dynamic_output_shape_4) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape_4) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_4,
          is_ignored_relaxed_dynamic_output_shape_4,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape_4) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_relaxed_all_inputs_as_internal_4) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_4,
          is_ignored_relaxed_all_inputs_as_internal_4,
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_4());
}
...
TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_4) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape_4) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_4,
          is_ignored_float16_dynamic_output_shape_4,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape_4) {
  const Model model = createTestModel_float16_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_float16_all_inputs_as_internal_4) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_4,
          is_ignored_float16_all_inputs_as_internal_4,
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_4());
}
...
TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_4) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_4) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_4(), true);
}

TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_4) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_4();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_4());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape_5) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_5,
          is_ignored_relaxed_dynamic_output_shape_5,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_5(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape_5) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_5();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape_5) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_5,
          is_ignored_float16_dynamic_output_shape_5,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape_5(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape_5) {
  const Model model = createTestModel_float16_dynamic_output_shape_5();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape_6) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_6,
          is_ignored_relaxed_dynamic_output_shape_6,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_6(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape_6) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_6();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_6());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape_6) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_6,
          is_ignored_float16_dynamic_output_shape_6,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape_6(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape_6) {
  const Model model = createTestModel_float16_dynamic_output_shape_6();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape_6());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_all_inputs_as_internal_5) {
  Execute(device,
          createTestModel_all_inputs_as_internal_5,
          is_ignored_all_inputs_as_internal_5,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_5());
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_5) {
  const Model model = createTestModel_all_inputs_as_internal_5();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_all_inputs_as_internal_dynamic_output_shape_5) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_5,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_5,
          ::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_5(), true);
}

TEST_F(ValidationTest, slice_all_inputs_as_internal_dynamic_output_shape_5) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_5();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_all_inputs_as_internal_dynamic_output_shape_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape_7) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_7,
          is_ignored_relaxed_dynamic_output_shape_7,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_7(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape_7) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_7();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_7());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_relaxed_all_inputs_as_internal_5) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_5,
          is_ignored_relaxed_all_inputs_as_internal_5,
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_5());
}
...
TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_5) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_5) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_5(), true);
}

TEST_F(ValidationTest, slice_relaxed_all_inputs_as_internal_dynamic_output_shape_5) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_5();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape_7) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_7,
          is_ignored_float16_dynamic_output_shape_7,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape_7(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape_7) {
  const Model model = createTestModel_float16_dynamic_output_shape_7();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape_7());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, slice_float16_all_inputs_as_internal_5) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_5,
          is_ignored_float16_all_inputs_as_internal_5,
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_5());
}
...
TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_5) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_5) {
  Execute(device,
          ...
          ::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_5(), true);
}

TEST_F(ValidationTest, slice_float16_all_inputs_as_internal_dynamic_output_shape_5) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_5();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_5());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_relaxed_dynamic_output_shape_8) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_8,
          is_ignored_relaxed_dynamic_output_shape_8,
          ::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_8(), true);
}

TEST_F(ValidationTest, slice_relaxed_dynamic_output_shape_8) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_8();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_relaxed_dynamic_output_shape_8());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_float16_dynamic_output_shape_8) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_8,
          is_ignored_float16_dynamic_output_shape_8,
          ::generated_tests::slice::get_examples_float16_dynamic_output_shape_8(), true);
}

TEST_F(ValidationTest, slice_float16_dynamic_output_shape_8) {
  const Model model = createTestModel_float16_dynamic_output_shape_8();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_float16_dynamic_output_shape_8());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_zero_sized_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_zero_sized_relaxed_dynamic_output_shape,
          is_ignored_zero_sized_relaxed_dynamic_output_shape,
          ::generated_tests::slice::get_examples_zero_sized_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_zero_sized_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_zero_sized_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_zero_sized_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_zero_sized_quant8_dynamic_output_shape) {
  Execute(device,
          createTestModel_zero_sized_quant8_dynamic_output_shape,
          is_ignored_zero_sized_quant8_dynamic_output_shape,
          ::generated_tests::slice::get_examples_zero_sized_quant8_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_zero_sized_quant8_dynamic_output_shape) {
  const Model model = createTestModel_zero_sized_quant8_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_zero_sized_quant8_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, slice_zero_sized_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_zero_sized_float16_dynamic_output_shape,
          is_ignored_zero_sized_float16_dynamic_output_shape,
          ::generated_tests::slice::get_examples_zero_sized_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, slice_zero_sized_float16_dynamic_output_shape) {
  const Model model = createTestModel_zero_sized_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::slice::get_examples_zero_sized_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
