...
Model createTestModel_regular_all_inputs_as_internal();
bool is_ignored_regular_all_inputs_as_internal(int);

TEST_F(NeuralnetworksHidlTest, detection_postprocess_regular_all_inputs_as_internal) {
  Execute(device,
          createTestModel_regular_all_inputs_as_internal,
          is_ignored_regular_all_inputs_as_internal,
          ::generated_tests::detection_postprocess::get_examples_regular_all_inputs_as_internal());
}

TEST_F(ValidationTest, detection_postprocess_regular_all_inputs_as_internal) {
  const Model model = createTestModel_regular_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
Model createTestModel_regular_all_inputs_as_internal_dynamic_output_shape();
bool is_ignored_regular_all_inputs_as_internal_dynamic_output_shape(int);

TEST_F(DynamicOutputShapeTest, detection_postprocess_regular_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_regular_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_regular_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_regular_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_regular_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_regular_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
Model createTestModel_regular_relaxed_dynamic_output_shape();
bool is_ignored_regular_relaxed_dynamic_output_shape(int);

TEST_F(DynamicOutputShapeTest, detection_postprocess_regular_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_regular_relaxed_dynamic_output_shape,
          is_ignored_regular_relaxed_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_regular_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_regular_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_regular_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
Model createTestModel_regular_relaxed_all_inputs_as_internal();
bool is_ignored_regular_relaxed_all_inputs_as_internal(int);

TEST_F(NeuralnetworksHidlTest, detection_postprocess_regular_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_regular_relaxed_all_inputs_as_internal,
          is_ignored_regular_relaxed_all_inputs_as_internal,
          ::generated_tests::detection_postprocess::get_examples_regular_relaxed_all_inputs_as_internal());
}

TEST_F(ValidationTest, detection_postprocess_regular_relaxed_all_inputs_as_internal) {
  const Model model = createTestModel_regular_relaxed_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
Model createTestModel_regular_relaxed_all_inputs_as_internal_dynamic_output_shape();
bool is_ignored_regular_relaxed_all_inputs_as_internal_dynamic_output_shape(int);

TEST_F(DynamicOutputShapeTest, detection_postprocess_regular_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_regular_relaxed_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_regular_relaxed_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_regular_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_regular_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_regular_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
Model createTestModel_regular_float16_dynamic_output_shape();
bool is_ignored_regular_float16_dynamic_output_shape(int);

TEST_F(DynamicOutputShapeTest, detection_postprocess_regular_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_regular_float16_dynamic_output_shape,
          is_ignored_regular_float16_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_regular_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_regular_float16_dynamic_output_shape) {
  const Model model = createTestModel_regular_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
Model createTestModel_regular_float16_all_inputs_as_internal();
bool is_ignored_regular_float16_all_inputs_as_internal(int);

TEST_F(NeuralnetworksHidlTest, detection_postprocess_regular_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_regular_float16_all_inputs_as_internal,
          is_ignored_regular_float16_all_inputs_as_internal,
          ::generated_tests::detection_postprocess::get_examples_regular_float16_all_inputs_as_internal());
}

TEST_F(ValidationTest, detection_postprocess_regular_float16_all_inputs_as_internal) {
  const Model model = createTestModel_regular_float16_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
Model createTestModel_regular_float16_all_inputs_as_internal_dynamic_output_shape();
bool is_ignored_regular_float16_all_inputs_as_internal_dynamic_output_shape(int);

TEST_F(DynamicOutputShapeTest, detection_postprocess_regular_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_regular_float16_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_regular_float16_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_regular_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_regular_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_regular_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_regular_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_all_inputs_as_internal) {
  Execute(device,
          createTestModel_all_inputs_as_internal,
          is_ignored_all_inputs_as_internal,
          ::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal());
}

TEST_F(ValidationTest, detection_postprocess_all_inputs_as_internal) {
  const Model model = createTestModel_all_inputs_as_internal();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape,
          is_ignored_all_inputs_as_internal_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_relaxed_dynamic_output_shape) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape,
          is_ignored_relaxed_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_relaxed_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_relaxed_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_relaxed_all_inputs_as_internal) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal,
          is_ignored_relaxed_all_inputs_as_internal,
          ::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, detection_postprocess_relaxed_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_relaxed_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_float16_dynamic_output_shape) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape,
          is_ignored_float16_dynamic_output_shape,
          ::generated_tests::detection_postprocess::get_examples_float16_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_float16_dynamic_output_shape) {
  const Model model = createTestModel_float16_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_float16_all_inputs_as_internal) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal,
          is_ignored_float16_all_inputs_as_internal,
          ::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal());
}
...
TEST_F(ValidationTest, detection_postprocess_float16_all_inputs_as_internal) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_float16_all_inputs_as_internal_dynamic_output_shape) {
  Execute(device,
          ...
          ::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_dynamic_output_shape(), true);
}

TEST_F(ValidationTest, detection_postprocess_float16_all_inputs_as_internal_dynamic_output_shape) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_dynamic_output_shape());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_all_inputs_as_internal_2,
          is_ignored_all_inputs_as_internal_2,
          ::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, detection_postprocess_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_2,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_2,
          ::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, detection_postprocess_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_relaxed_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_2,
          is_ignored_relaxed_dynamic_output_shape_2,
          ::generated_tests::detection_postprocess::get_examples_relaxed_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, detection_postprocess_relaxed_dynamic_output_shape_2) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_relaxed_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_2,
          is_ignored_relaxed_all_inputs_as_internal_2,
          ::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, detection_postprocess_relaxed_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, detection_postprocess_relaxed_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_float16_dynamic_output_shape_2) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_2,
          is_ignored_float16_dynamic_output_shape_2,
          ::generated_tests::detection_postprocess::get_examples_float16_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, detection_postprocess_float16_dynamic_output_shape_2) {
  const Model model = createTestModel_float16_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_float16_all_inputs_as_internal_2) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_2,
          is_ignored_float16_all_inputs_as_internal_2,
          ::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_2());
}
...
TEST_F(ValidationTest, detection_postprocess_float16_all_inputs_as_internal_2) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_2());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  Execute(device,
          ...
          ::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_2(), true);
}

TEST_F(ValidationTest, detection_postprocess_float16_all_inputs_as_internal_dynamic_output_shape_2) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_2();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_2());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_all_inputs_as_internal_3,
          is_ignored_all_inputs_as_internal_3,
          ::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, detection_postprocess_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          createTestModel_all_inputs_as_internal_dynamic_output_shape_3,
          is_ignored_all_inputs_as_internal_dynamic_output_shape_3,
          ::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, detection_postprocess_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_relaxed_dynamic_output_shape_3) {
  Execute(device,
          createTestModel_relaxed_dynamic_output_shape_3,
          is_ignored_relaxed_dynamic_output_shape_3,
          ::generated_tests::detection_postprocess::get_examples_relaxed_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, detection_postprocess_relaxed_dynamic_output_shape_3) {
  const Model model = createTestModel_relaxed_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_relaxed_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_relaxed_all_inputs_as_internal_3,
          is_ignored_relaxed_all_inputs_as_internal_3,
          ::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, detection_postprocess_relaxed_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_relaxed_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, detection_postprocess_relaxed_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_relaxed_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_relaxed_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_float16_dynamic_output_shape_3) {
  Execute(device,
          createTestModel_float16_dynamic_output_shape_3,
          is_ignored_float16_dynamic_output_shape_3,
          ::generated_tests::detection_postprocess::get_examples_float16_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, detection_postprocess_float16_dynamic_output_shape_3) {
  const Model model = createTestModel_float16_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_dynamic_output_shape_3());
  validateEverything(model, requests);
}
...
TEST_F(NeuralnetworksHidlTest, detection_postprocess_float16_all_inputs_as_internal_3) {
  Execute(device,
          createTestModel_float16_all_inputs_as_internal_3,
          is_ignored_float16_all_inputs_as_internal_3,
          ::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_3());
}
...
TEST_F(ValidationTest, detection_postprocess_float16_all_inputs_as_internal_3) {
  ...
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_3());
  validateEverything(model, requests);
}
...
TEST_F(DynamicOutputShapeTest, detection_postprocess_float16_all_inputs_as_internal_dynamic_output_shape_3) {
  Execute(device,
          ...
          ::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_3(), true);
}

TEST_F(ValidationTest, detection_postprocess_float16_all_inputs_as_internal_dynamic_output_shape_3) {
  const Model model = createTestModel_float16_all_inputs_as_internal_dynamic_output_shape_3();
  const std::vector<Request> requests = createRequests(::generated_tests::detection_postprocess::get_examples_float16_all_inputs_as_internal_dynamic_output_shape_3());
  validateEverything(model, requests);
}
