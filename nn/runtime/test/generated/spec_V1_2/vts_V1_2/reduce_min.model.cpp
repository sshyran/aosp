...
Model createTestModel_all_inputs_as_internal_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {3};
    std::vector<uint8_t> operandValues = {
      1, 0, 0, 0, 0, 0, 0, 0, 253, 255, 255, 255, 253, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_float16_all_inputs_as_internal_3() {
    const std::vector<Operand> operands = {
        ...
        },
        {
            ...
            .zeroPoint = 0,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 17, .length = 2},
        },
        {
            .type = OperandType::INT32,
            .dimensions = {},
            ...
            .zeroPoint = 0,
            .lifetime = OperandLifeTime::CONSTANT_COPY,
            .location = {.poolIndex = 0, .offset = 19, .length = 4},
        }
    };
    ...
    const std::vector<uint32_t> outputIndexes = {3};
    std::vector<uint8_t> operandValues = {
      1, 0, 0, 0, 0, 0, 0, 0, 253, 255, 255, 255, 253, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
...
Model createTestModel_quant8_all_inputs_as_internal_3() {
    ...
    const std::vector<uint32_t> outputIndexes = {3};
    std::vector<uint8_t> operandValues = {
      1, 0, 0, 0, 0, 0, 0, 0, 253, 255, 255, 255, 253, 255, 255, 255, 0, 127, 0, 0, 0, 0
    };
    const std::vector<hidl_memory> pools = {};
