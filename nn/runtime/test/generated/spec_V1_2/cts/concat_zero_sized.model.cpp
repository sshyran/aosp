...
void CreateModel_quant8(Model *model) {
  ...
  OperandType type16(Type::TENSOR_QUANT8_ASYMM, {0, 2, 2, 2}, 0.1f, 128);
...
void CreateModel_quant8_dynamic_output_shape(Model *model) {
  ...
  OperandType type19(Type::TENSOR_QUANT8_ASYMM, {1, 2}, 0.1f, 128);
  OperandType type20(Type::TENSOR_QUANT8_ASYMM, {0}, 0.1f, 128);
  OperandType type21(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 0.1f, 128);
  OperandType type3(Type::TENSOR_INT32, {0});
  OperandType type5(Type::TENSOR_INT32, {1});
  OperandType type6(Type::FLOAT32, {});
  OperandType type7(Type::INT32, {});
...
void CreateModel_quant8_2(Model *model) {
  ...
  OperandType type8(Type::BOOL, {});
  // Phase 1, operands
  auto scores1 = model->addOperand(&type19);
  auto roi1 = model->addOperand(&type17);
  auto param14 = model->addOperand(&type5);
  auto param15 = model->addOperand(&type6);
  auto param16 = model->addOperand(&type7);
  auto param17 = model->addOperand(&type7);
...
void CreateModel_float16_2(Model *model) {
  ...
  OperandType type8(Type::BOOL, {});
  // Phase 1, operands
  auto scores1 = model->addOperand(&type28);
  auto roi1 = model->addOperand(&type26);
  auto param14 = model->addOperand(&type5);
  auto param15 = model->addOperand(&type25);
  auto param16 = model->addOperand(&type7);
  auto param17 = model->addOperand(&type7);
  auto param18 = model->addOperand(&type25);
  auto param19 = model->addOperand(&type25);
  auto param20 = model->addOperand(&type25);
  auto scoresOut1 = model->addOperand(&type29);
  ...
  auto param21 = model->addOperand(&type7);
  auto param22 = model->addOperand(&type7);
  auto param23 = model->addOperand(&type25);
  auto param24 = model->addOperand(&type25);
  auto param25 = model->addOperand(&type7);
  auto param26 = model->addOperand(&type7);
  auto layout1 = model->addOperand(&type8);
  auto featureMap1 = model->addOperand(&type22);
