...
TEST_F(GeneratedTests, bidirectional_sequence_lstm_float16_batch_major_aux_input_blackbox) {
    execute(CreateModel,
            is_ignored,
...
TEST_AVAILABLE_SINCE(V1_2, bidirectional_sequence_lstm_float16_batch_major_aux_input_blackbox, generated_tests::bidirectional_sequence_lstm_float16_batch_major_aux_input::CreateModel)
...
TEST_F(GeneratedTests, bidirectional_sequence_lstm_float16_batch_major_aux_input_blackbox_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_2, bidirectional_sequence_lstm_float16_batch_major_aux_input_blackbox_all_inputs_as_internal, generated_tests::bidirectional_sequence_lstm_float16_batch_major_aux_input::CreateModel_all_inputs_as_internal)
