...
void CreateModel(Model *model) {
  ...
  OperandType type12(Type::TENSOR_FLOAT32, {2, 4, 16});
  ...
  OperandType type5(Type::TENSOR_FLOAT32, {16});
  ...
  auto input_layer_norm_weights = model->addOperand(&type11);
  auto forget_layer_norm_weights = model->addOperand(&type11);
  auto cell_layer_norm_weights = model->addOperand(&type11);
  auto output_layer_norm_weights = model->addOperand(&type11);
...
void CreateModel_all_inputs_as_internal(Model *model) {
  ...
  auto projection_bias_tmp = model->addOperand(&type5);
  ...
  model->addOperation(ANEURALNETWORKS_ADD, {projection_bias_tmp, dummy17, param17}, {projection_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {output_state_in_tmp, dummy18, param18}, {output_state_in});
  model->addOperation(ANEURALNETWORKS_ADD, {cell_state_in_tmp, dummy19, param19}, {cell_state_in});
  model->addOperation(ANEURALNETWORKS_UNIDIRECTIONAL_SEQUENCE_LSTM, {input, input_to_input_weights, input_to_forget_weights, input_to_cell_weights, input_to_output_weights, recurrent_to_intput_weights, recurrent_to_forget_weights, recurrent_to_cell_weights, recurrent_to_output_weights, cell_to_input_weights, cell_to_forget_weights, cell_to_output_weights, input_gate_bias, forget_gate_bias, cell_gate_bias, output_gate_bias, projection_weights, projection_bias, output_state_in, cell_state_in, activation_param, cell_clip_param, proj_clip_param, time_major_param, input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights}, {output});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights, input_tmp, input_to_input_weights_tmp, input_to_forget_weights_tmp, input_to_cell_weights_tmp, input_to_output_weights_tmp, recurrent_to_intput_weights_tmp, recurrent_to_forget_weights_tmp, recurrent_to_cell_weights_tmp, recurrent_to_output_weights_tmp, cell_to_input_weights_tmp, cell_to_forget_weights_tmp, cell_to_output_weights_tmp, input_gate_bias_tmp, forget_gate_bias_tmp, cell_gate_bias_tmp, output_gate_bias_tmp, projection_weights_tmp, projection_bias_tmp, output_state_in_tmp, cell_state_in_tmp},
    {output});
  assert(model->isValid());
}
...
void CreateModel_all_inputs_as_internal_dynamic_output_shape(Model *model) {
  ...
  model->addOperation(ANEURALNETWORKS_ADD, {input_to_input_weights_tmp, dummy21, param21}, {input_to_input_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {input_to_forget_weights_tmp, dummy22, param22}, {input_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {input_to_cell_weights_tmp, dummy23, param23}, {input_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {input_to_output_weights_tmp, dummy24, param24}, {input_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {recurrent_to_intput_weights_tmp, dummy25, param25}, {recurrent_to_intput_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {recurrent_to_forget_weights_tmp, dummy26, param26}, {recurrent_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {recurrent_to_cell_weights_tmp, dummy27, param27}, {recurrent_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {recurrent_to_output_weights_tmp, dummy28, param28}, {recurrent_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {cell_to_input_weights_tmp, dummy29, param29}, {cell_to_input_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {cell_to_forget_weights_tmp, dummy30, param30}, {cell_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {cell_to_output_weights_tmp, dummy31, param31}, {cell_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {input_gate_bias_tmp, dummy32, param32}, {input_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {forget_gate_bias_tmp, dummy33, param33}, {forget_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {cell_gate_bias_tmp, dummy34, param34}, {cell_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {output_gate_bias_tmp, dummy35, param35}, {output_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {projection_weights_tmp, dummy36, param36}, {projection_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {projection_bias_tmp, dummy37, param37}, {projection_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {output_state_in_tmp, dummy38, param38}, {output_state_in});
  model->addOperation(ANEURALNETWORKS_ADD, {cell_state_in_tmp, dummy39, param39}, {cell_state_in});
  model->addOperation(ANEURALNETWORKS_UNIDIRECTIONAL_SEQUENCE_LSTM, {input, input_to_input_weights, input_to_forget_weights, input_to_cell_weights, input_to_output_weights, recurrent_to_intput_weights, recurrent_to_forget_weights, recurrent_to_cell_weights, recurrent_to_output_weights, cell_to_input_weights, cell_to_forget_weights, cell_to_output_weights, input_gate_bias, forget_gate_bias, cell_gate_bias, output_gate_bias, projection_weights, projection_bias, output_state_in, cell_state_in, activation_param, cell_clip_param, proj_clip_param, time_major_param, input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights}, {output});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights, input_tmp, input_to_input_weights_tmp, input_to_forget_weights_tmp, input_to_cell_weights_tmp, input_to_output_weights_tmp, recurrent_to_intput_weights_tmp, recurrent_to_forget_weights_tmp, recurrent_to_cell_weights_tmp, recurrent_to_output_weights_tmp, cell_to_input_weights_tmp, cell_to_forget_weights_tmp, cell_to_output_weights_tmp, input_gate_bias_tmp, forget_gate_bias_tmp, cell_gate_bias_tmp, output_gate_bias_tmp, projection_weights_tmp, projection_bias_tmp, output_state_in_tmp, cell_state_in_tmp},
