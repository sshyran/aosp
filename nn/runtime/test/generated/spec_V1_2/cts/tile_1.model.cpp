...
void CreateModel_float16(Model *model) {
  ...
  OperandType type7(Type::TENSOR_FLOAT16, {6});
  // Phase 1, operands
...
void CreateModel_quant8(Model *model) {
  OperandType type1(Type::TENSOR_INT32, {1});
  OperandType type11(Type::TENSOR_QUANT8_ASYMM, {3}, 0.5f, 127);
  OperandType type12(Type::TENSOR_QUANT8_ASYMM, {6}, 0.5f, 127);
  // Phase 1, operands
...
void CreateModel_quant8_dynamic_output_shape(Model *model) {
  OperandType type1(Type::TENSOR_INT32, {1});
  OperandType type11(Type::TENSOR_QUANT8_ASYMM, {3}, 0.5f, 127);
  OperandType type13(Type::TENSOR_QUANT8_ASYMM, {0}, 0.5f, 127);
  // Phase 1, operands
  auto input0 = model->addOperand(&type11);
  auto multipliers = model->addOperand(&type1);
