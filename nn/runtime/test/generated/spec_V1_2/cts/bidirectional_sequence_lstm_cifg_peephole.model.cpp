...
void CreateModel_all_inputs_as_internal(Model *model) {
  ...
  model->addOperation(ANEURALNETWORKS_ADD, {fw_input_to_forget_weights_tmp, dummy1, param1}, {fw_input_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_input_to_cell_weights_tmp, dummy2, param2}, {fw_input_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_input_to_output_weights_tmp, dummy3, param3}, {fw_input_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_recurrent_to_forget_weights_tmp, dummy4, param4}, {fw_recurrent_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_recurrent_to_cell_weights_tmp, dummy5, param5}, {fw_recurrent_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_recurrent_to_output_weights_tmp, dummy6, param6}, {fw_recurrent_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_to_forget_weights_tmp, dummy7, param7}, {fw_cell_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_to_output_weights_tmp, dummy8, param8}, {fw_cell_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_forget_gate_bias_tmp, dummy9, param9}, {fw_forget_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_bias_tmp, dummy10, param10}, {fw_cell_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_output_gate_bias_tmp, dummy11, param11}, {fw_output_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_input_to_forget_weights_tmp, dummy12, param12}, {bw_input_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_input_to_cell_weights_tmp, dummy13, param13}, {bw_input_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_input_to_output_weights_tmp, dummy14, param14}, {bw_input_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_recurrent_to_forget_weights_tmp, dummy15, param15}, {bw_recurrent_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_recurrent_to_cell_weights_tmp, dummy16, param16}, {bw_recurrent_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_recurrent_to_output_weights_tmp, dummy17, param17}, {bw_recurrent_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_to_forget_weights_tmp, dummy18, param18}, {bw_cell_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_to_output_weights_tmp, dummy19, param19}, {bw_cell_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_forget_gate_bias_tmp, dummy20, param20}, {bw_forget_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_bias_tmp, dummy21, param21}, {bw_cell_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_output_gate_bias_tmp, dummy22, param22}, {bw_output_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_activatiom_state_tmp, dummy23, param23}, {fw_activatiom_state});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_state_tmp, dummy24, param24}, {fw_cell_state});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_activatiom_state_tmp, dummy25, param25}, {bw_activatiom_state});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_state_tmp, dummy26, param26}, {bw_cell_state});
  model->addOperation(ANEURALNETWORKS_BIDIRECTIONAL_SEQUENCE_LSTM, {input, fw_input_to_input_weights, fw_input_to_forget_weights, fw_input_to_cell_weights, fw_input_to_output_weights, fw_recurrent_to_input_weights, fw_recurrent_to_forget_weights, fw_recurrent_to_cell_weights, fw_recurrent_to_output_weights, fw_cell_to_input_weights, fw_cell_to_forget_weights, fw_cell_to_output_weights, fw_input_gate_bias, fw_forget_gate_bias, fw_cell_bias, fw_output_gate_bias, fw_projection_weights, fw_projection_bias, bw_input_to_input_weights, bw_input_to_forget_weights, bw_input_to_cell_weights, bw_input_to_output_weights, bw_recurrent_to_input_weights, bw_recurrent_to_forget_weights, bw_recurrent_to_cell_weights, bw_recurrent_to_output_weights, bw_cell_to_input_weights, bw_cell_to_forget_weights, bw_cell_to_output_weights, bw_input_gate_bias, bw_forget_gate_bias, bw_cell_bias, bw_output_gate_bias, bw_projection_weights, bw_projection_bias, fw_activatiom_state, fw_cell_state, bw_activatiom_state, bw_cell_state, input1, fw_aux_input_to_input_weights, fw_input_to_forget_weights1, fw_aux_input_to_cell_weights, fw_aux_input_to_output_weights, bw_aux_input_to_input_weights, bw_input_to_forget_weights1, bw_aux_input_to_cell_weights, bw_aux_input_to_output_weights, activation, cell_clip, proj_clip, merge_outputs, time_major, input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights, input_layer_norm_weights1, forget_layer_norm_weights1, cell_layer_norm_weights1, output_layer_norm_weights1}, {fw_output, bw_output});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {fw_input_to_input_weights, fw_recurrent_to_input_weights, fw_cell_to_input_weights, fw_input_gate_bias, fw_projection_weights, fw_projection_bias, bw_input_to_input_weights, bw_recurrent_to_input_weights, bw_cell_to_input_weights, bw_input_gate_bias, bw_projection_weights, bw_projection_bias, input1, fw_aux_input_to_input_weights, fw_input_to_forget_weights1, fw_aux_input_to_cell_weights, fw_aux_input_to_output_weights, bw_aux_input_to_input_weights, bw_input_to_forget_weights1, bw_aux_input_to_cell_weights, bw_aux_input_to_output_weights, input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights, input_layer_norm_weights1, forget_layer_norm_weights1, cell_layer_norm_weights1, output_layer_norm_weights1, input_tmp, fw_input_to_forget_weights_tmp, fw_input_to_cell_weights_tmp, fw_input_to_output_weights_tmp, fw_recurrent_to_forget_weights_tmp, fw_recurrent_to_cell_weights_tmp, fw_recurrent_to_output_weights_tmp, fw_cell_to_forget_weights_tmp, fw_cell_to_output_weights_tmp, fw_forget_gate_bias_tmp, fw_cell_bias_tmp, fw_output_gate_bias_tmp, bw_input_to_forget_weights_tmp, bw_input_to_cell_weights_tmp, bw_input_to_output_weights_tmp, bw_recurrent_to_forget_weights_tmp, bw_recurrent_to_cell_weights_tmp, bw_recurrent_to_output_weights_tmp, bw_cell_to_forget_weights_tmp, bw_cell_to_output_weights_tmp, bw_forget_gate_bias_tmp, bw_cell_bias_tmp, bw_output_gate_bias_tmp, fw_activatiom_state_tmp, fw_cell_state_tmp, bw_activatiom_state_tmp, bw_cell_state_tmp},
    {fw_output, bw_output});
  assert(model->isValid());
}
...
void CreateModel_all_inputs_as_internal_dynamic_output_shape(Model *model) {
  ...
  model->addOperation(ANEURALNETWORKS_ADD, {fw_input_to_forget_weights_tmp, dummy28, param28}, {fw_input_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_input_to_cell_weights_tmp, dummy29, param29}, {fw_input_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_input_to_output_weights_tmp, dummy30, param30}, {fw_input_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_recurrent_to_forget_weights_tmp, dummy31, param31}, {fw_recurrent_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_recurrent_to_cell_weights_tmp, dummy32, param32}, {fw_recurrent_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_recurrent_to_output_weights_tmp, dummy33, param33}, {fw_recurrent_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_to_forget_weights_tmp, dummy34, param34}, {fw_cell_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_to_output_weights_tmp, dummy35, param35}, {fw_cell_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_forget_gate_bias_tmp, dummy36, param36}, {fw_forget_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_bias_tmp, dummy37, param37}, {fw_cell_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_output_gate_bias_tmp, dummy38, param38}, {fw_output_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_input_to_forget_weights_tmp, dummy39, param39}, {bw_input_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_input_to_cell_weights_tmp, dummy40, param40}, {bw_input_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_input_to_output_weights_tmp, dummy41, param41}, {bw_input_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_recurrent_to_forget_weights_tmp, dummy42, param42}, {bw_recurrent_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_recurrent_to_cell_weights_tmp, dummy43, param43}, {bw_recurrent_to_cell_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_recurrent_to_output_weights_tmp, dummy44, param44}, {bw_recurrent_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_to_forget_weights_tmp, dummy45, param45}, {bw_cell_to_forget_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_to_output_weights_tmp, dummy46, param46}, {bw_cell_to_output_weights});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_forget_gate_bias_tmp, dummy47, param47}, {bw_forget_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_bias_tmp, dummy48, param48}, {bw_cell_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_output_gate_bias_tmp, dummy49, param49}, {bw_output_gate_bias});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_activatiom_state_tmp, dummy50, param50}, {fw_activatiom_state});
  model->addOperation(ANEURALNETWORKS_ADD, {fw_cell_state_tmp, dummy51, param51}, {fw_cell_state});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_activatiom_state_tmp, dummy52, param52}, {bw_activatiom_state});
  model->addOperation(ANEURALNETWORKS_ADD, {bw_cell_state_tmp, dummy53, param53}, {bw_cell_state});
  model->addOperation(ANEURALNETWORKS_BIDIRECTIONAL_SEQUENCE_LSTM, {input, fw_input_to_input_weights, fw_input_to_forget_weights, fw_input_to_cell_weights, fw_input_to_output_weights, fw_recurrent_to_input_weights, fw_recurrent_to_forget_weights, fw_recurrent_to_cell_weights, fw_recurrent_to_output_weights, fw_cell_to_input_weights, fw_cell_to_forget_weights, fw_cell_to_output_weights, fw_input_gate_bias, fw_forget_gate_bias, fw_cell_bias, fw_output_gate_bias, fw_projection_weights, fw_projection_bias, bw_input_to_input_weights, bw_input_to_forget_weights, bw_input_to_cell_weights, bw_input_to_output_weights, bw_recurrent_to_input_weights, bw_recurrent_to_forget_weights, bw_recurrent_to_cell_weights, bw_recurrent_to_output_weights, bw_cell_to_input_weights, bw_cell_to_forget_weights, bw_cell_to_output_weights, bw_input_gate_bias, bw_forget_gate_bias, bw_cell_bias, bw_output_gate_bias, bw_projection_weights, bw_projection_bias, fw_activatiom_state, fw_cell_state, bw_activatiom_state, bw_cell_state, input1, fw_aux_input_to_input_weights, fw_input_to_forget_weights1, fw_aux_input_to_cell_weights, fw_aux_input_to_output_weights, bw_aux_input_to_input_weights, bw_input_to_forget_weights1, bw_aux_input_to_cell_weights, bw_aux_input_to_output_weights, activation, cell_clip, proj_clip, merge_outputs, time_major, input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights, input_layer_norm_weights1, forget_layer_norm_weights1, cell_layer_norm_weights1, output_layer_norm_weights1}, {fw_output, bw_output});
  // Phase 3, inputs and outputs
  model->identifyInputsAndOutputs(
    {fw_input_to_input_weights, fw_recurrent_to_input_weights, fw_cell_to_input_weights, fw_input_gate_bias, fw_projection_weights, fw_projection_bias, bw_input_to_input_weights, bw_recurrent_to_input_weights, bw_cell_to_input_weights, bw_input_gate_bias, bw_projection_weights, bw_projection_bias, input1, fw_aux_input_to_input_weights, fw_input_to_forget_weights1, fw_aux_input_to_cell_weights, fw_aux_input_to_output_weights, bw_aux_input_to_input_weights, bw_input_to_forget_weights1, bw_aux_input_to_cell_weights, bw_aux_input_to_output_weights, input_layer_norm_weights, forget_layer_norm_weights, cell_layer_norm_weights, output_layer_norm_weights, input_layer_norm_weights1, forget_layer_norm_weights1, cell_layer_norm_weights1, output_layer_norm_weights1, input_tmp, fw_input_to_forget_weights_tmp, fw_input_to_cell_weights_tmp, fw_input_to_output_weights_tmp, fw_recurrent_to_forget_weights_tmp, fw_recurrent_to_cell_weights_tmp, fw_recurrent_to_output_weights_tmp, fw_cell_to_forget_weights_tmp, fw_cell_to_output_weights_tmp, fw_forget_gate_bias_tmp, fw_cell_bias_tmp, fw_output_gate_bias_tmp, bw_input_to_forget_weights_tmp, bw_input_to_cell_weights_tmp, bw_input_to_output_weights_tmp, bw_recurrent_to_forget_weights_tmp, bw_recurrent_to_cell_weights_tmp, bw_recurrent_to_output_weights_tmp, bw_cell_to_forget_weights_tmp, bw_cell_to_output_weights_tmp, bw_forget_gate_bias_tmp, bw_cell_bias_tmp, bw_output_gate_bias_tmp, fw_activatiom_state_tmp, fw_cell_state_tmp, bw_activatiom_state_tmp, bw_cell_state_tmp},
