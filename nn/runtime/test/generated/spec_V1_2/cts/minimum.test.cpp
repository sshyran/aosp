...
TEST_F(GeneratedTests, minimum_simple_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_2, minimum_simple_all_inputs_as_internal, generated_tests::minimum::CreateModel_all_inputs_as_internal)
...
TEST_F(GeneratedTests, minimum_simple_relaxed_all_inputs_as_internal) {
...
TEST_F(GeneratedTests, minimum_simple_float16_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_2, minimum_simple_float16_all_inputs_as_internal, generated_tests::minimum::CreateModel_float16_all_inputs_as_internal)
...
TEST_F(DynamicOutputShapeTest, minimum_simple_quant8_dynamic_output_shape) {
    execute(CreateModel_quant8_dynamic_output_shape,
            ...
            get_examples_simple_quant8_dynamic_output_shape());
}
...
TEST_F(GeneratedTests, minimum_simple_quant8_all_inputs_as_internal) {
    execute(CreateModel_quant8_all_inputs_as_internal,
            is_ignored_quant8_all_inputs_as_internal,
            get_examples_simple_quant8_all_inputs_as_internal());
}

} // namespace generated_tests::minimum
TEST_AVAILABLE_SINCE(V1_2, minimum_simple_quant8_all_inputs_as_internal, generated_tests::minimum::CreateModel_quant8_all_inputs_as_internal)
...
TEST_F(DynamicOutputShapeTest, minimum_simple_quant8_all_inputs_as_internal_dynamic_output_shape) {
    execute(CreateModel_quant8_all_inputs_as_internal_dynamic_output_shape,
            ...
            get_examples_simple_quant8_all_inputs_as_internal_dynamic_output_shape());
}
...
TEST_F(GeneratedTests, minimum_broadcast_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_2, minimum_broadcast_all_inputs_as_internal, generated_tests::minimum::CreateModel_all_inputs_as_internal_2)
...
TEST_F(GeneratedTests, minimum_broadcast_relaxed_all_inputs_as_internal) {
...
TEST_F(GeneratedTests, minimum_broadcast_float16_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_2, minimum_broadcast_float16_all_inputs_as_internal, generated_tests::minimum::CreateModel_float16_all_inputs_as_internal_2)
...
TEST_F(DynamicOutputShapeTest, minimum_broadcast_quant8_dynamic_output_shape) {
    execute(CreateModel_quant8_dynamic_output_shape_2,
            ...
            get_examples_broadcast_quant8_dynamic_output_shape());
}
...
TEST_F(GeneratedTests, minimum_broadcast_quant8_all_inputs_as_internal) {
    execute(CreateModel_quant8_all_inputs_as_internal_2,
            is_ignored_quant8_all_inputs_as_internal_2,
            get_examples_broadcast_quant8_all_inputs_as_internal());
}

} // namespace generated_tests::minimum
TEST_AVAILABLE_SINCE(V1_2, minimum_broadcast_quant8_all_inputs_as_internal, generated_tests::minimum::CreateModel_quant8_all_inputs_as_internal_2)
...
TEST_F(DynamicOutputShapeTest, minimum_broadcast_quant8_all_inputs_as_internal_dynamic_output_shape) {
    execute(CreateModel_quant8_all_inputs_as_internal_dynamic_output_shape_2,
            ...
            get_examples_broadcast_quant8_all_inputs_as_internal_dynamic_output_shape());
}
...
TEST_F(GeneratedTests, minimum_overflow_all_inputs_as_internal) {
    execute(CreateModel_all_inputs_as_internal_3,
            is_ignored_all_inputs_as_internal_3,
            get_examples_overflow_all_inputs_as_internal());
}

} // namespace generated_tests::minimum
TEST_AVAILABLE_SINCE(V1_2, minimum_overflow_all_inputs_as_internal, generated_tests::minimum::CreateModel_all_inputs_as_internal_3)
...
TEST_F(DynamicOutputShapeTest, minimum_overflow_all_inputs_as_internal_dynamic_output_shape) {
    execute(CreateModel_all_inputs_as_internal_dynamic_output_shape_3,
            ...
            get_examples_overflow_all_inputs_as_internal_dynamic_output_shape());
}
