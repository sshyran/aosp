...
TEST_F(GeneratedTests, pad_v2_all_dims_quant8) {
    execute(CreateModel,
            is_ignored,
            get_examples());
}
...
TEST_AVAILABLE_SINCE(V1_2, pad_v2_all_dims_quant8, generated_tests::pad_v2_all_dims_quant8::CreateModel)
...
TEST_F(GeneratedTests, pad_v2_all_dims_quant8_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_2, pad_v2_all_dims_quant8_all_inputs_as_internal, generated_tests::pad_v2_all_dims_quant8::CreateModel_all_inputs_as_internal)
...
TEST_F(GeneratedTests, pad_v2_all_dims_quant8_all_tensors_as_inputs) {
...
TEST_AVAILABLE_SINCE(V1_2, pad_v2_all_dims_quant8_all_tensors_as_inputs, generated_tests::pad_v2_all_dims_quant8::CreateModel_all_tensors_as_inputs)
...
TEST_F(GeneratedTests, pad_v2_all_dims_quant8_all_tensors_as_inputs_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_2, pad_v2_all_dims_quant8_all_tensors_as_inputs_all_inputs_as_internal, generated_tests::pad_v2_all_dims_quant8::CreateModel_all_tensors_as_inputs_all_inputs_as_internal)
