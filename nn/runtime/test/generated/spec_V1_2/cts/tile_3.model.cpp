...
void CreateModel_dynamic_output_shape(Model *model) {
  OperandType type0(Type::TENSOR_FLOAT32, {1, 2, 3});
  OperandType type1(Type::TENSOR_INT32, {3});
  OperandType type3(Type::TENSOR_FLOAT32, {0, 0, 0});
  // Phase 1, operands
  auto input0 = model->addOperand(&type0);
  auto multipliers = model->addOperand(&type1);
...
void CreateModel_float16(Model *model) {
  OperandType type1(Type::TENSOR_INT32, {3});
  OperandType type6(Type::TENSOR_FLOAT16, {1, 2, 3});
  OperandType type7(Type::TENSOR_FLOAT16, {2, 6, 3});
  // Phase 1, operands
...
void CreateModel_float16_all_inputs_as_internal(Model *model) {
  ...
  OperandType type5(Type::INT32, {});
  OperandType type7(Type::TENSOR_FLOAT16, {2, 6, 3});
  OperandType type9(Type::TENSOR_FLOAT16, {1, 2, 3});
  // Phase 1, operands
...
void CreateModel_quant8(Model *model) {
  OperandType type1(Type::TENSOR_INT32, {3});
  OperandType type11(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3}, 0.5f, 127);
  OperandType type12(Type::TENSOR_QUANT8_ASYMM, {2, 6, 3}, 0.5f, 127);
  // Phase 1, operands
...
void CreateModel_quant8_dynamic_output_shape(Model *model) {
  OperandType type1(Type::TENSOR_INT32, {3});
  OperandType type11(Type::TENSOR_QUANT8_ASYMM, {1, 2, 3}, 0.5f, 127);
  OperandType type13(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0}, 0.5f, 127);
  // Phase 1, operands
  auto input0 = model->addOperand(&type11);
  auto multipliers = model->addOperand(&type1);
...
void CreateModel_int32(Model *model) {
  OperandType type1(Type::TENSOR_INT32, {3});
  OperandType type15(Type::TENSOR_INT32, {1, 2, 3});
  OperandType type16(Type::TENSOR_INT32, {2, 6, 3});
  // Phase 1, operands
...
void CreateModel_int32_dynamic_output_shape(Model *model) {
  OperandType type1(Type::TENSOR_INT32, {3});
  OperandType type15(Type::TENSOR_INT32, {1, 2, 3});
  OperandType type17(Type::TENSOR_INT32, {0, 0, 0});
  // Phase 1, operands
  auto input0 = model->addOperand(&type15);
  auto multipliers = model->addOperand(&type1);
