...
void CreateModel_2(Model *model) {
  OperandType type1(Type::TENSOR_FLOAT16, {2, 30, 24, 2});
  // Phase 1, operands
...
void CreateModel_zero_sized_quant8(Model *model) {
  ...
  OperandType type18(Type::TENSOR_QUANT16_ASYMM, {1, 8}, 0.125f, 0);
  OperandType type19(Type::TENSOR_QUANT16_ASYMM, {0, 4}, 0.125f, 0);
  OperandType type20(Type::TENSOR_QUANT8_ASYMM, {1, 2}, 0.1f, 128);
  OperandType type21(Type::TENSOR_QUANT8_ASYMM, {0}, 0.1f, 128);
  OperandType type5(Type::TENSOR_INT32, {0});
  OperandType type7(Type::TENSOR_INT32, {1});
  OperandType type8(Type::FLOAT32, {});
  OperandType type9(Type::INT32, {});
...
void CreateModel_zero_sized_quant8_dynamic_output_shape(Model *model) {
  ...
  OperandType type20(Type::TENSOR_QUANT8_ASYMM, {1, 2}, 0.1f, 128);
  OperandType type21(Type::TENSOR_QUANT8_ASYMM, {0}, 0.1f, 128);
  OperandType type22(Type::TENSOR_QUANT8_ASYMM, {0, 0, 0, 0}, 0.1f, 128);
  OperandType type5(Type::TENSOR_INT32, {0});
  OperandType type7(Type::TENSOR_INT32, {1});
  OperandType type8(Type::FLOAT32, {});
  OperandType type9(Type::INT32, {});
