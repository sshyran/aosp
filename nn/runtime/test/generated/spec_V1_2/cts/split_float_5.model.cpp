...
void CreateModel(Model *model) {
  OperandType type0(Type::TENSOR_FLOAT32, {2, 2, 2});
...
void CreateModel_float16(Model *model) {
  OperandType type1(Type::INT32, {});
  OperandType type5(Type::TENSOR_FLOAT16, {2, 2, 2});
  OperandType type6(Type::TENSOR_FLOAT16, {2, 1, 2});
  // Phase 1, operands
...
void CreateModel_float16_dynamic_output_shape(Model *model) {
  OperandType type1(Type::INT32, {});
  OperandType type5(Type::TENSOR_FLOAT16, {2, 2, 2});
  OperandType type7(Type::TENSOR_FLOAT16, {0, 0, 0});
  // Phase 1, operands
  auto input0 = model->addOperand(&type5);
  auto axis = model->addOperand(&type1);
  auto num_splits = model->addOperand(&type1);
...
void CreateModel_float16_all_inputs_as_internal(Model *model) {
  OperandType type1(Type::INT32, {});
  OperandType type6(Type::TENSOR_FLOAT16, {2, 1, 2});
  OperandType type8(Type::TENSOR_FLOAT16, {2, 2, 2});
