...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  ...
  .int32Operands = {},
  // int -> QUANT8_ASYMM map
  .quant8Operands = {{0, {128, 176, 224, 132, 180, 228, 136, 184, 232, 140, 188, 236, 144, 192, 240, 148, 196, 244, 152, 200, 248, 156, 204, 252, 160, 208, 255, 164, 212, 255, 168, 216, 255, 172, 220, 255}}},
  // int -> QUANT16_SYMM map
  .quant16Operands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  ...
  .int32Operands = {},
  // int -> QUANT8_ASYMM map
  .quant8Operands = {{0, {128, 176, 224, 144, 192, 240, 160, 208, 255, 132, 180, 228, 148, 196, 244, 164, 212, 255, 136, 184, 232, 152, 200, 248, 168, 216, 255, 140, 188, 236, 156, 204, 252, 172, 220, 255}}},
  // int -> QUANT16_SYMM map
  .quant16Operands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  ...
  .int32Operands = {},
  // int -> QUANT8_ASYMM map
  .quant8Operands = {{0, {128, 132, 136, 140, 144, 148, 152, 156, 160, 164, 168, 172, 176, 180, 184, 188, 192, 196, 200, 204, 208, 212, 216, 220, 224, 228, 232, 236, 240, 244, 248, 252, 255, 255, 255, 255}}},
  // int -> QUANT16_SYMM map
  .quant16Operands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  ...
  .int32Operands = {},
  // int -> QUANT8_ASYMM map
  .quant8Operands = {{0, {128, 132, 136, 140, 144, 148, 152, 156, 160, 164, 168, 172}}},
  // int -> QUANT16_SYMM map
  .quant16Operands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
...
{ // See tools/test_generator/include/TestHarness.h:MixedTyped
  ...
  .int32Operands = {},
  // int -> QUANT8_ASYMM map
  .quant8Operands = {{0, {128, 144, 160, 132, 148, 164, 136, 152, 168, 140, 156, 172}}},
  // int -> QUANT16_SYMM map
  .quant16Operands = {},
  // int -> FLOAT16 map
  .float16Operands = {},
