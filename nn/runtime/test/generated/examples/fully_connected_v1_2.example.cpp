...
std::vector<MixedTypedExample>& get_examples_quant8_mult_gt_1() {
static std::vector<MixedTypedExample> examples_quant8_mult_gt_1 = {
// Begin of an example
{
.operands = {
//Input(s)
...
std::vector<MixedTypedExample>& get_examples_dynamic_output_shape_quant8_mult_gt_1() {
static std::vector<MixedTypedExample> examples_dynamic_output_shape_quant8_mult_gt_1 = {
// Begin of an example
{
.operands = {
//Input(s)
...
return examples_dynamic_output_shape_quant8_mult_gt_1;
};
