...
TEST_AVAILABLE_SINCE(V1_0, rnn_state, generated_tests::rnn_state::CreateModel)
...
TEST_F(GeneratedTests, rnn_state_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, rnn_state_all_inputs_as_internal, generated_tests::rnn_state::CreateModel_all_inputs_as_internal)
