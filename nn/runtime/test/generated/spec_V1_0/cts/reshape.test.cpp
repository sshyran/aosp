...
TEST_F(GeneratedTests, reshape_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, reshape_all_inputs_as_internal, generated_tests::reshape::CreateModel_all_inputs_as_internal)
...
TEST_F(GeneratedTests, reshape_all_tensors_as_inputs) {
...
TEST_AVAILABLE_SINCE(V1_0, reshape_all_tensors_as_inputs, generated_tests::reshape::CreateModel_all_tensors_as_inputs)
...
TEST_F(GeneratedTests, reshape_all_tensors_as_inputs_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, reshape_all_tensors_as_inputs_all_inputs_as_internal, generated_tests::reshape::CreateModel_all_tensors_as_inputs_all_inputs_as_internal)
