...
TEST_F(GeneratedTests, mul_relu_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, mul_relu_all_inputs_as_internal, generated_tests::mul_relu::CreateModel_all_inputs_as_internal)
