...
TEST_AVAILABLE_SINCE(V1_0, add, generated_tests::add::CreateModel)
...
TEST_F(GeneratedTests, add_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, add_all_inputs_as_internal, generated_tests::add::CreateModel_all_inputs_as_internal)
