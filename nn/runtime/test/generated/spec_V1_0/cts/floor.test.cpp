...
TEST_F(GeneratedTests, floor_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, floor_all_inputs_as_internal, generated_tests::floor::CreateModel_all_inputs_as_internal)
