...
TEST_F(GeneratedTests, conv_float_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, conv_float_all_inputs_as_internal, generated_tests::conv_float::CreateModel_all_inputs_as_internal)
...
TEST_F(GeneratedTests, conv_float_all_tensors_as_inputs) {
...
TEST_AVAILABLE_SINCE(V1_0, conv_float_all_tensors_as_inputs, generated_tests::conv_float::CreateModel_all_tensors_as_inputs)
...
TEST_F(GeneratedTests, conv_float_all_tensors_as_inputs_all_inputs_as_internal) {
...
TEST_AVAILABLE_SINCE(V1_0, conv_float_all_tensors_as_inputs_all_inputs_as_internal, generated_tests::conv_float::CreateModel_all_tensors_as_inputs_all_inputs_as_internal)
