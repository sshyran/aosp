...
TEST_F(DynamicOutputShapeTest, logistic_quant8_2) {
    Execute(device, ::generated_tests::logistic_quant8_2::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, logistic_quant8_2_all_inputs_as_internal) {
    Execute(device, ::generated_tests::logistic_quant8_2::get_test_model_all_inputs_as_internal(), true);
}
