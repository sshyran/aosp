...
TEST_F(DynamicOutputShapeTest, relu_quant8_1) {
    Execute(device, ::generated_tests::relu_quant8_1::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, relu_quant8_1_all_inputs_as_internal) {
    Execute(device, ::generated_tests::relu_quant8_1::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, relu_quant8_1_2) {
    Execute(device, ::generated_tests::relu_quant8_1::get_test_model_2(), true);
}
...
TEST_F(DynamicOutputShapeTest, relu_quant8_1_all_inputs_as_internal_2) {
    Execute(device, ::generated_tests::relu_quant8_1::get_test_model_all_inputs_as_internal_2(), true);
}
