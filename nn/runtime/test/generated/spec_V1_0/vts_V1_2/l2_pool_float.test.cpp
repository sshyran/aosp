...
TEST_F(DynamicOutputShapeTest, l2_pool_float) {
    Execute(device, ::generated_tests::l2_pool_float::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, l2_pool_float_all_inputs_as_internal) {
    Execute(device, ::generated_tests::l2_pool_float::get_test_model_all_inputs_as_internal(), true);
}
