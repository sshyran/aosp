...
TEST_F(DynamicOutputShapeTest, lsh_projection_2) {
    Execute(device, ::generated_tests::lsh_projection_2::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, lsh_projection_2_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::lsh_projection_2::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, lsh_projection_2_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::lsh_projection_2::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
