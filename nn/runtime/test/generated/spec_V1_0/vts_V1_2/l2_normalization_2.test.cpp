...
TEST_F(DynamicOutputShapeTest, l2_normalization_2) {
    Execute(device, ::generated_tests::l2_normalization_2::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, l2_normalization_2_all_inputs_as_internal) {
    Execute(device, ::generated_tests::l2_normalization_2::get_test_model_all_inputs_as_internal(), true);
}
