...
TEST_F(DynamicOutputShapeTest, mul) {
    Execute(device, ::generated_tests::mul::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, mul_all_inputs_as_internal) {
    Execute(device, ::generated_tests::mul::get_test_model_all_inputs_as_internal(), true);
}
