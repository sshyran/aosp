...
TEST_F(DynamicOutputShapeTest, depthwise_conv) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv_all_inputs_as_internal) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv_all_tensors_as_inputs) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model_all_tensors_as_inputs(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv_all_tensors_as_inputs_all_inputs_as_internal) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model_all_tensors_as_inputs_all_inputs_as_internal(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv_2) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model_2(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv_all_inputs_as_internal_2) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model_all_inputs_as_internal_2(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv_all_tensors_as_inputs_2) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model_all_tensors_as_inputs_2(), true);
}
...
TEST_F(DynamicOutputShapeTest, depthwise_conv_all_tensors_as_inputs_all_inputs_as_internal_2) {
    Execute(device, ::generated_tests::depthwise_conv::get_test_model_all_tensors_as_inputs_all_inputs_as_internal_2(), true);
}
