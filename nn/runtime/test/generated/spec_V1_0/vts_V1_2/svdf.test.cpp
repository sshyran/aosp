...
TEST_F(DynamicOutputShapeTest, svdf) {
    Execute(device, ::generated_tests::svdf::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, svdf_all_inputs_as_internal) {
    Execute(device, ::generated_tests::svdf::get_test_model_all_inputs_as_internal(), true);
}
