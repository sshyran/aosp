...
TEST_F(DynamicOutputShapeTest, lstm3_state) {
    Execute(device, ::generated_tests::lstm3_state::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, lstm3_state_all_inputs_as_internal) {
    Execute(device, ::generated_tests::lstm3_state::get_test_model_all_inputs_as_internal(), true);
}
