...
TEST_F(DynamicOutputShapeTest, lstm3_state3) {
    Execute(device, ::generated_tests::lstm3_state3::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, lstm3_state3_all_inputs_as_internal) {
    Execute(device, ::generated_tests::lstm3_state3::get_test_model_all_inputs_as_internal(), true);
}
