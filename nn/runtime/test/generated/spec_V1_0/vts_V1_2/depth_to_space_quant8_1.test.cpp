...
TEST_F(DynamicOutputShapeTest, depth_to_space_quant8_1) {
    Execute(device, ::generated_tests::depth_to_space_quant8_1::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, depth_to_space_quant8_1_all_inputs_as_internal) {
    Execute(device, ::generated_tests::depth_to_space_quant8_1::get_test_model_all_inputs_as_internal(), true);
}
