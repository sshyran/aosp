...
TEST_F(DynamicOutputShapeTest, svdf2) {
    Execute(device, ::generated_tests::svdf2::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, svdf2_all_inputs_as_internal) {
    Execute(device, ::generated_tests::svdf2::get_test_model_all_inputs_as_internal(), true);
}
