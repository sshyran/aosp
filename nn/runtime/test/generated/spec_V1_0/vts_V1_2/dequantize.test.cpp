...
TEST_F(DynamicOutputShapeTest, dequantize) {
    Execute(device, ::generated_tests::dequantize::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, dequantize_all_inputs_as_internal) {
    Execute(device, ::generated_tests::dequantize::get_test_model_all_inputs_as_internal(), true);
}
