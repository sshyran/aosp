...
TEST_F(DynamicOutputShapeTest, lstm_state) {
    Execute(device, ::generated_tests::lstm_state::get_test_model(), true);
}
...
TEST_F(DynamicOutputShapeTest, lstm_state_all_inputs_as_internal) {
    Execute(device, ::generated_tests::lstm_state::get_test_model_all_inputs_as_internal(), true);
}
