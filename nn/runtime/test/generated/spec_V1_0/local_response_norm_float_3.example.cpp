...
const auto dummy_test_model = TestModelManager::get().add("local_response_norm_float_3", get_test_model());
...
const auto dummy_test_model_all_inputs_as_internal = TestModelManager::get().add("local_response_norm_float_3_all_inputs_as_internal", get_test_model_all_inputs_as_internal());
